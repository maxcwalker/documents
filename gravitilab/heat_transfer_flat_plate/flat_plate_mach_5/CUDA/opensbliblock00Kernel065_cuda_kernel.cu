...
//
__constant__ int dims_opensbliblock00Kernel065 [14][1];
static int dims_opensbliblock00Kernel065_h [14][1] = {0};

//user function
__device__

 void opensbliblock00Kernel065_gpu(const ACC<double> &Residual0_B0,
...
int size1 ){
  ...
  arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel065[5][0];
  arg6 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel065[6][0];
  arg7 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel065[7][0];
  arg8 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel065[8][0];
  arg9 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel065[9][0];
  arg10 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel065[10][0];
  arg11 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel065[11][0];

  if (idx_x < size0 && idx_y < size1) {
    const ACC<double> argp0(dims_opensbliblock00Kernel065[0][0], arg0);
    const ACC<double> argp1(dims_opensbliblock00Kernel065[1][0], arg1);
    const ACC<double> argp2(dims_opensbliblock00Kernel065[2][0], arg2);
    const ACC<double> argp3(dims_opensbliblock00Kernel065[3][0], arg3);
    ACC<double> argp4(dims_opensbliblock00Kernel065[4][0], arg4);
    ACC<double> argp5(dims_opensbliblock00Kernel065[5][0], arg5);
    ACC<double> argp6(dims_opensbliblock00Kernel065[6][0], arg6);
    ACC<double> argp7(dims_opensbliblock00Kernel065[7][0], arg7);
    ACC<double> argp8(dims_opensbliblock00Kernel065[8][0], arg8);
    ACC<double> argp9(dims_opensbliblock00Kernel065[9][0], arg9);
    ACC<double> argp10(dims_opensbliblock00Kernel065[10][0], arg10);
    ACC<double> argp11(dims_opensbliblock00Kernel065[11][0], arg11);
...
void ops_par_loop_opensbliblock00Kernel065_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel065_h[0][0] || xdim1 != dims_opensbliblock00Kernel065_h[1][0] || xdim2 != dims_opensbliblock00Kernel065_h[2][0] || xdim3 != dims_opensbliblock00Kernel065_h[3][0] || xdim4 != dims_opensbliblock00Kernel065_h[4][0] || xdim5 != dims_opensbliblock00Kernel065_h[5][0] || xdim6 != dims_opensbliblock00Kernel065_h[6][0] || xdim7 != dims_opensbliblock00Kernel065_h[7][0] || xdim8 != dims_opensbliblock00Kernel065_h[8][0] || xdim9 != dims_opensbliblock00Kernel065_h[9][0] || xdim10 != dims_opensbliblock00Kernel065_h[10][0] || xdim11 != dims_opensbliblock00Kernel065_h[11][0]) {
