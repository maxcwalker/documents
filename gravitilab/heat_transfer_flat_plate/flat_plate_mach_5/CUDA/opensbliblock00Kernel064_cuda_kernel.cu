...
//
__constant__ int dims_opensbliblock00Kernel064 [13][1];
static int dims_opensbliblock00Kernel064_h [13][1] = {0};
...
int size1 ){
  ...
  arg9 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel064[9][0];
  arg10 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel064[10][0];
  arg11 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel064[11][0];
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    const ACC<double> argp2(dims_opensbliblock00Kernel064[2][0], arg2);
    const ACC<double> argp3(dims_opensbliblock00Kernel064[3][0], arg3);
    ...
    ACC<double> argp9(dims_opensbliblock00Kernel064[9][0], arg9);
    ACC<double> argp10(dims_opensbliblock00Kernel064[10][0], arg10);
    ACC<double> argp11(dims_opensbliblock00Kernel064[11][0], arg11);
