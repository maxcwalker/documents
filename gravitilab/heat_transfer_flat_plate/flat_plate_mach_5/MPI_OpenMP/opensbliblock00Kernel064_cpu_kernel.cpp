...
void ops_par_loop_opensbliblock00Kernel064_execute(ops_kernel_descriptor *desc) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,6,"opensbliblock00Kernel064");
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> D00_B0(xdim0_opensbliblock00Kernel064, D00_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel064*1);
      const ACC<double> D01_B0(xdim1_opensbliblock00Kernel064, D01_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel064*1);
      const ACC<double> D10_B0(xdim2_opensbliblock00Kernel064, D10_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel064*1);
      const ACC<double> D11_B0(xdim3_opensbliblock00Kernel064, D11_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel064*1);
      ACC<double> SD000_B0(xdim4_opensbliblock00Kernel064, SD000_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel064*1);
      ACC<double> SD001_B0(xdim5_opensbliblock00Kernel064, SD001_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel064*1);
      ACC<double> SD010_B0(xdim6_opensbliblock00Kernel064, SD010_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel064*1);
      ACC<double> SD011_B0(xdim7_opensbliblock00Kernel064, SD011_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel064*1);
      ACC<double> SD100_B0(xdim8_opensbliblock00Kernel064, SD100_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel064*1);
      ACC<double> SD101_B0(xdim9_opensbliblock00Kernel064, SD101_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel064*1);
      ACC<double> SD110_B0(xdim10_opensbliblock00Kernel064, SD110_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel064*1);
      ACC<double> SD111_B0(xdim11_opensbliblock00Kernel064, SD111_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel064*1);
