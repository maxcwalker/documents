...
void ops_par_loop_opensbliblock00Kernel050_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ACC<double> rhoE_B0(xdim0_opensbliblock00Kernel050, rhoE_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel050*1);
      ACC<double> rho_B0(xdim1_opensbliblock00Kernel050, rho_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel050*1);
      ACC<double> rhou0_B0(xdim2_opensbliblock00Kernel050, rhou0_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel050*1);
      ACC<double> rhou1_B0(xdim3_opensbliblock00Kernel050, rhou1_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel050*1);
