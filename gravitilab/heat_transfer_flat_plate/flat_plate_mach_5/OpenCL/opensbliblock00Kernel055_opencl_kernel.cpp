...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel055(OPS_instance *instance, int xdim0, int xdim1, int xdim2, int xdim3, int xdim4, int xdim5, int xdim6, int xdim7, int xdim8, int xdim9, int xdim10) {
      ...
      if(!isbuilt_opensbliblock00Kernel055) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[1] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel055", &ret);
        clSafeCall( ret );
