...
ptr_double SD111_B0,
  ...
  const int *idx, const int block0np0, const double inv2Delta0block0, const double inv2Delta1block0, const double inv2Minf, const double invDelta0block0, const double invDelta1block0, const double invPr, const double invRe, const double inv_gamma_m1)
{
   double d1_mu_dx = 0.0;
   double d1_mu_dy = 0.0;
   ...
   if (idx[1] == 0){
    ...
    OPS_ACCS(Residual3_B0, 0,0) = (OPS_ACCS(D00_B0, 0,0)*OPS_ACCS(wk1_B0, 0,0) + OPS_ACCS(D10_B0, 0,0)*OPS_ACCS(wk5_B0, 0,0))*(OPS_ACCS(D00_B0, 0,0)*OPS_ACCS(wk1_B0, 0,0) +
      OPS_ACCS(D01_B0, 0,0)*OPS_ACCS(wk0_B0, 0,0) + OPS_ACCS(D10_B0, 0,0)*OPS_ACCS(wk5_B0, 0,0) + OPS_ACCS(D11_B0, 0,0)*OPS_ACCS(wk4_B0, 0,0))*invRe*OPS_ACCS(mu_B0, 0,0) +
      (OPS_ACCS(D00_B0, 0,0)*d1_mu_dx + OPS_ACCS(D10_B0, 0,0)*d1_mu_dy)*(OPS_ACCS(D00_B0, 0,0)*OPS_ACCS(wk1_B0, 0,0) + OPS_ACCS(D01_B0, 0,0)*OPS_ACCS(wk0_B0, 0,0) +
      OPS_ACCS(D10_B0, 0,0)*OPS_ACCS(wk5_B0, 0,0) + OPS_ACCS(D11_B0, 0,0)*OPS_ACCS(wk4_B0, 0,0))*invRe*OPS_ACCS(u1_B0, 0,0) + (OPS_ACCS(D01_B0, 0,0)*OPS_ACCS(wk0_B0, 0,0) +
      OPS_ACCS(D11_B0, 0,0)*OPS_ACCS(wk4_B0, 0,0))*(OPS_ACCS(D00_B0, 0,0)*OPS_ACCS(wk1_B0, 0,0) + OPS_ACCS(D01_B0, 0,0)*OPS_ACCS(wk0_B0, 0,0) + OPS_ACCS(D10_B0, 0,0)*OPS_ACCS(wk5_B0, 0,0) +
      OPS_ACCS(D11_B0, 0,0)*OPS_ACCS(wk4_B0, 0,0))*invRe*OPS_ACCS(mu_B0, 0,0) + (OPS_ACCS(D01_B0, 0,0)*d1_mu_dx + OPS_ACCS(D11_B0, 0,0)*d1_mu_dy)*(OPS_ACCS(D00_B0, 0,0)*OPS_ACCS(wk1_B0, 0,0)
      + OPS_ACCS(D01_B0, 0,0)*OPS_ACCS(wk0_B0, 0,0) + OPS_ACCS(D10_B0, 0,0)*OPS_ACCS(wk5_B0, 0,0) + OPS_ACCS(D11_B0, 0,0)*OPS_ACCS(wk4_B0, 0,0))*invRe*OPS_ACCS(u0_B0, 0,0) -
      (2.0/3.0)*(OPS_ACCS(D01_B0, 0,0)*OPS_ACCS(wk1_B0, 0,0) + OPS_ACCS(D11_B0, 0,0)*OPS_ACCS(wk5_B0, 0,0))*(OPS_ACCS(D00_B0, 0,0)*OPS_ACCS(wk0_B0, 0,0) + OPS_ACCS(D10_B0, 0,0)*OPS_ACCS(wk4_B0, 0,0) -
      2*OPS_ACCS(D01_B0, 0,0)*OPS_ACCS(wk1_B0, 0,0) - 2*OPS_ACCS(D11_B0, 0,0)*OPS_ACCS(wk5_B0, 0,0))*invRe*OPS_ACCS(mu_B0, 0,0) - (2.0/3.0)*(OPS_ACCS(D01_B0, 0,0)*d1_mu_dx +
      OPS_ACCS(D11_B0, 0,0)*d1_mu_dy)*(OPS_ACCS(D00_B0, 0,0)*OPS_ACCS(wk0_B0, 0,0) + OPS_ACCS(D10_B0, 0,0)*OPS_ACCS(wk4_B0, 0,0) - 2*OPS_ACCS(D01_B0, 0,0)*OPS_ACCS(wk1_B0, 0,0) -
      ...
      2*OPS_ACCS(D00_B0, 0,0)*OPS_ACCS(wk0_B0, 0,0) + 2*OPS_ACCS(D10_B0, 0,0)*OPS_ACCS(wk4_B0, 0,0))*invRe*OPS_ACCS(u0_B0, 0,0) + (OPS_ACCS(D00_B0, 0,0)*OPS_ACCS(wk3_B0, 0,0) +
      OPS_ACCS(D10_B0, 0,0)*OPS_ACCS(wk7_B0, 0,0))*(OPS_ACCS(D00_B0, 0,0)*d1_mu_dx + OPS_ACCS(D10_B0, 0,0)*d1_mu_dy)*invPr*invRe*inv2Minf*inv_gamma_m1 +
      (OPS_ACCS(D01_B0, 0,0)*OPS_ACCS(wk3_B0, 0,0) + OPS_ACCS(D11_B0, 0,0)*OPS_ACCS(wk7_B0, 0,0))*(OPS_ACCS(D01_B0, 0,0)*d1_mu_dx +
      OPS_ACCS(D11_B0, 0,0)*d1_mu_dy)*invPr*invRe*inv2Minf*inv_gamma_m1 + ((OPS_ACCS(D00_B0, 0,0)*OPS_ACCS(D00_B0, 0,0))*d2_T_dx +
      (OPS_ACCS(D01_B0, 0,0)*OPS_ACCS(D01_B0, 0,0))*d2_T_dx + (OPS_ACCS(D10_B0, 0,0)*OPS_ACCS(D10_B0, 0,0))*d2_T_dy + (OPS_ACCS(D11_B0, 0,0)*OPS_ACCS(D11_B0, 0,0))*d2_T_dy +
      OPS_ACCS(D00_B0, 0,0)*OPS_ACCS(wk3_B0, 0,0)*OPS_ACCS(SD000_B0, 0,0) + OPS_ACCS(D00_B0, 0,0)*OPS_ACCS(wk7_B0, 0,0)*OPS_ACCS(SD100_B0, 0,0) +
      OPS_ACCS(D01_B0, 0,0)*OPS_ACCS(wk3_B0, 0,0)*OPS_ACCS(SD010_B0, 0,0) + OPS_ACCS(D01_B0, 0,0)*OPS_ACCS(wk7_B0, 0,0)*OPS_ACCS(SD110_B0, 0,0) +
      OPS_ACCS(D10_B0, 0,0)*OPS_ACCS(wk3_B0, 0,0)*OPS_ACCS(SD001_B0, 0,0) + OPS_ACCS(D10_B0, 0,0)*OPS_ACCS(wk7_B0, 0,0)*OPS_ACCS(SD101_B0, 0,0) +
      OPS_ACCS(D11_B0, 0,0)*OPS_ACCS(wk3_B0, 0,0)*OPS_ACCS(SD011_B0, 0,0) + OPS_ACCS(D11_B0, 0,0)*OPS_ACCS(wk7_B0, 0,0)*OPS_ACCS(SD111_B0, 0,0) +
      2*OPS_ACCS(D00_B0, 0,0)*OPS_ACCS(D10_B0, 0,0)*d1_wk3_dy +
      2*OPS_ACCS(D01_B0, 0,0)*OPS_ACCS(D11_B0, 0,0)*d1_wk3_dy)*invPr*invRe*inv2Minf*inv_gamma_m1*OPS_ACCS(mu_B0, 0,0) + OPS_ACCS(Residual3_B0, 0,0);
...
const int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    const ptr_double ptr1 = { &arg1[base1 + idx_x * 1*1 + idx_y * 1*1 * xdim1_opensbliblock00Kernel044], xdim1_opensbliblock00Kernel044};
    const ptr_double ptr2 = { &arg2[base2 + idx_x * 1*1 + idx_y * 1*1 * xdim2_opensbliblock00Kernel044], xdim2_opensbliblock00Kernel044};
    const ptr_double ptr3 = { &arg3[base3 + idx_x * 1*1 + idx_y * 1*1 * xdim3_opensbliblock00Kernel044], xdim3_opensbliblock00Kernel044};
    const ptr_double ptr4 = { &arg4[base4 + idx_x * 1*1 + idx_y * 1*1 * xdim4_opensbliblock00Kernel044], xdim4_opensbliblock00Kernel044};
    const ptr_double ptr5 = { &arg5[base5 + idx_x * 1*1 + idx_y * 1*1 * xdim5_opensbliblock00Kernel044], xdim5_opensbliblock00Kernel044};
    const ptr_double ptr6 = { &arg6[base6 + idx_x * 1*1 + idx_y * 1*1 * xdim6_opensbliblock00Kernel044], xdim6_opensbliblock00Kernel044};
    const ptr_double ptr7 = { &arg7[base7 + idx_x * 1*1 + idx_y * 1*1 * xdim7_opensbliblock00Kernel044], xdim7_opensbliblock00Kernel044};
    const ptr_double ptr8 = { &arg8[base8 + idx_x * 1*1 + idx_y * 1*1 * xdim8_opensbliblock00Kernel044], xdim8_opensbliblock00Kernel044};
    const ptr_double ptr9 = { &arg9[base9 + idx_x * 1*1 + idx_y * 1*1 * xdim9_opensbliblock00Kernel044], xdim9_opensbliblock00Kernel044};
    const ptr_double ptr10 = { &arg10[base10 + idx_x * 1*1 + idx_y * 1*1 * xdim10_opensbliblock00Kernel044], xdim10_opensbliblock00Kernel044};
    const ptr_double ptr11 = { &arg11[base11 + idx_x * 1*1 + idx_y * 1*1 * xdim11_opensbliblock00Kernel044], xdim11_opensbliblock00Kernel044};
    const ptr_double ptr12 = { &arg12[base12 + idx_x * 1*1 + idx_y * 1*1 * xdim12_opensbliblock00Kernel044], xdim12_opensbliblock00Kernel044};
    const ptr_double ptr13 = { &arg13[base13 + idx_x * 1*1 + idx_y * 1*1 * xdim13_opensbliblock00Kernel044], xdim13_opensbliblock00Kernel044};
    const ptr_double ptr14 = { &arg14[base14 + idx_x * 1*1 + idx_y * 1*1 * xdim14_opensbliblock00Kernel044], xdim14_opensbliblock00Kernel044};
    const ptr_double ptr15 = { &arg15[base15 + idx_x * 1*1 + idx_y * 1*1 * xdim15_opensbliblock00Kernel044], xdim15_opensbliblock00Kernel044};
    const ptr_double ptr16 = { &arg16[base16 + idx_x * 1*1 + idx_y * 1*1 * xdim16_opensbliblock00Kernel044], xdim16_opensbliblock00Kernel044};
    const ptr_double ptr17 = { &arg17[base17 + idx_x * 1*1 + idx_y * 1*1 * xdim17_opensbliblock00Kernel044], xdim17_opensbliblock00Kernel044};
    const ptr_double ptr18 = { &arg18[base18 + idx_x * 1*1 + idx_y * 1*1 * xdim18_opensbliblock00Kernel044], xdim18_opensbliblock00Kernel044};
    const ptr_double ptr19 = { &arg19[base19 + idx_x * 1*1 + idx_y * 1*1 * xdim19_opensbliblock00Kernel044], xdim19_opensbliblock00Kernel044};
    const ptr_double ptr20 = { &arg20[base20 + idx_x * 1*1 + idx_y * 1*1 * xdim20_opensbliblock00Kernel044], xdim20_opensbliblock00Kernel044};
    const ptr_double ptr21 = { &arg21[base21 + idx_x * 1*1 + idx_y * 1*1 * xdim21_opensbliblock00Kernel044], xdim21_opensbliblock00Kernel044};
    ptr_double ptr22 = { &arg22[base22 + idx_x * 1*1 + idx_y * 1*1 * xdim22_opensbliblock00Kernel044], xdim22_opensbliblock00Kernel044};
    ptr_double ptr23 = { &arg23[base23 + idx_x * 1*1 + idx_y * 1*1 * xdim23_opensbliblock00Kernel044], xdim23_opensbliblock00Kernel044};
    ptr_double ptr24 = { &arg24[base24 + idx_x * 1*1 + idx_y * 1*1 * xdim24_opensbliblock00Kernel044], xdim24_opensbliblock00Kernel044};
