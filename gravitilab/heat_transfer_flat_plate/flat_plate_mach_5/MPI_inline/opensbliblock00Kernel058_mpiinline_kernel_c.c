...
void opensbliblock00Kernel058_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ptr_double D00_B0 = { D00_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel058*1, xdim0_opensbliblock00Kernel058};
      ptr_double D01_B0 = { D01_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel058*1, xdim1_opensbliblock00Kernel058};
      ptr_double D10_B0 = { D10_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel058*1, xdim2_opensbliblock00Kernel058};
      ptr_double D11_B0 = { D11_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel058*1, xdim3_opensbliblock00Kernel058};
      ptr_double detJ_B0 = { detJ_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel058*1, xdim4_opensbliblock00Kernel058};
