...
//
__constant__ int dims_opensbliblock00Kernel055 [12][1];
static int dims_opensbliblock00Kernel055_h [12][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel055_gpu(const ACC<double> &x0_B0,
...
int size1 ){
  ...
  arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel055[5][0];
  arg6 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel055[6][0];
  arg7 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel055[7][0];
  arg8 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel055[8][0];
  arg9 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel055[9][0];
  arg10 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel055[10][0];

  if (idx_x < size0 && idx_y < size1) {
    const ACC<double> argp0(dims_opensbliblock00Kernel055[0][0], arg0);
    const ACC<double> argp1(dims_opensbliblock00Kernel055[1][0], arg1);
    ...
    ACC<double> argp5(dims_opensbliblock00Kernel055[5][0], arg5);
    ACC<double> argp6(dims_opensbliblock00Kernel055[6][0], arg6);
    ACC<double> argp7(dims_opensbliblock00Kernel055[7][0], arg7);
    ACC<double> argp8(dims_opensbliblock00Kernel055[8][0], arg8);
    ACC<double> argp9(dims_opensbliblock00Kernel055[9][0], arg9);
    ACC<double> argp10(dims_opensbliblock00Kernel055[10][0], arg10);
...
void ops_par_loop_opensbliblock00Kernel055_execute(ops_kernel_descriptor *desc) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,1,"opensbliblock00Kernel055");
  ...
  if (xdim0 != dims_opensbliblock00Kernel055_h[0][0] || xdim1 != dims_opensbliblock00Kernel055_h[1][0] || xdim2 != dims_opensbliblock00Kernel055_h[2][0] || xdim3 != dims_opensbliblock00Kernel055_h[3][0] || xdim4 != dims_opensbliblock00Kernel055_h[4][0] || xdim5 != dims_opensbliblock00Kernel055_h[5][0] || xdim6 != dims_opensbliblock00Kernel055_h[6][0] || xdim7 != dims_opensbliblock00Kernel055_h[7][0] || xdim8 != dims_opensbliblock00Kernel055_h[8][0] || xdim9 != dims_opensbliblock00Kernel055_h[9][0] || xdim10 != dims_opensbliblock00Kernel055_h[10][0]) {
    ...
    dims_opensbliblock00Kernel055_h[7][0] = xdim7;
    dims_opensbliblock00Kernel055_h[8][0] = xdim8;
    dims_opensbliblock00Kernel055_h[9][0] = xdim9;
    dims_opensbliblock00Kernel055_h[10][0] = xdim10;
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel055,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],
         ...
         (double *)p_a[10], arg_idx[0], arg_idx[1],x_size, y_size);
