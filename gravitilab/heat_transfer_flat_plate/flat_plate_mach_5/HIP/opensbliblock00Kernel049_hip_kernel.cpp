...
//
__constant__ int dims_opensbliblock00Kernel049 [4][1];
static int dims_opensbliblock00Kernel049_h [4][1] = {{0}};
...
void ops_par_loop_opensbliblock00Kernel049_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel049_h[0][0] || xdim1 != dims_opensbliblock00Kernel049_h[1][0] || xdim2 != dims_opensbliblock00Kernel049_h[2][0] || xdim3 != dims_opensbliblock00Kernel049_h[3][0]) {
