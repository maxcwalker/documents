...
if (restart == 0){
int iteration_range_34_block0[] = {-2, block0np0 + 2, -2, block0np1 + 2};
...
ops_par_loop(opensbliblock00Kernel037, "MetricsEquation evaluation", opensbliblock00, 2, iteration_range_37_block0,
...
int iteration_range_38_block0[] = {0, 1, -2, block0np1 + 2};
ops_par_loop(opensbliblock00Kernel038, "Metric_copy_block0 boundary dir0 side0", opensbliblock00, 2, iteration_range_38_block0,
...
int iteration_range_39_block0[] = {block0np0 - 1, block0np0, -2, block0np1 + 2};
ops_par_loop(opensbliblock00Kernel039, "Metric_copy_block0 boundary dir0 side1", opensbliblock00, 2, iteration_range_39_block0,
ops_arg_dat(D00_B0, 1, stencil_0_22_00_4, "double", OPS_RW),
ops_arg_dat(D01_B0, 1, stencil_0_22_00_4, "double", OPS_RW),
ops_arg_dat(D10_B0, 1, stencil_0_22_00_4, "double", OPS_RW),
ops_arg_dat(D11_B0, 1, stencil_0_22_00_4, "double", OPS_RW),
...
int iteration_range_40_block0[] = {-2, block0np0 + 2, 0, 1};
ops_par_loop(opensbliblock00Kernel040, "Metric_copy_block0 boundary dir1 side0", opensbliblock00, 2, iteration_range_40_block0,
...
int iteration_range_41_block0[] = {-2, block0np0 + 2, block0np1 - 1, block0np1};
ops_par_loop(opensbliblock00Kernel041, "Metric_copy_block0 boundary dir1 side1", opensbliblock00, 2, iteration_range_41_block0,
ops_arg_dat(D00_B0, 1, stencil_0_00_22_4, "double", OPS_RW),
ops_arg_dat(D01_B0, 1, stencil_0_00_22_4, "double", OPS_RW),
ops_arg_dat(D10_B0, 1, stencil_0_00_22_4, "double", OPS_RW),
ops_arg_dat(D11_B0, 1, stencil_0_00_22_4, "double", OPS_RW),
...
ops_par_loop(opensbliblock00Kernel046, "MetricsEquation evaluation", opensbliblock00, 2, iteration_range_46_block0,
...
ops_par_loop(opensbliblock00Kernel030, "InletTransfer boundary dir0 side0", opensbliblock00, 2, iteration_range_30_block0,
...
ops_par_loop(opensbliblock00Kernel031, "Extrapolation boundary dir0 side1", opensbliblock00, 2, iteration_range_31_block0,
...
ops_par_loop(opensbliblock00Kernel032, "IsothermalWall boundary dir1 side0", opensbliblock00, 2, iteration_range_32_block0,
...
ops_par_loop(opensbliblock00Kernel033, "ZeroGradientOutlet boundary dir1 side1", opensbliblock00, 2, iteration_range_33_block0,
...
ops_par_loop(opensbliblock00Kernel014, "CRp_B0", opensbliblock00, 2, iteration_range_14_block0,
...
ops_par_loop(opensbliblock00Kernel016, "CRU0_B0", opensbliblock00, 2, iteration_range_16_block0,
...
ops_par_loop(opensbliblock00Kernel019, "CRU1_B0", opensbliblock00, 2, iteration_range_19_block0,
...
ops_arg_dat(detJ_B0, 1, stencil_0_44_24_16, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel047, "Temporal solution advancement", opensbliblock00, 2, iteration_range_47_block0,
