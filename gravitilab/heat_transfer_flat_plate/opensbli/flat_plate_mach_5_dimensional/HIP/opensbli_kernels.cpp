...
int size, char *dat, char const *name){
  ...
  if (!strcmp(name,"R")) {
    hipSafeCall(instance->ostream(),hipMemcpyToSymbol(HIP_SYMBOL(R), dat, dim*size));
  }
  else
  if (!strcmp(name,"Re")) {
  ...
  if (!strcmp(name,"pref")) {
    hipSafeCall(instance->ostream(),hipMemcpyToSymbol(HIP_SYMBOL(pref), dat, dim*size));
  }
  else
