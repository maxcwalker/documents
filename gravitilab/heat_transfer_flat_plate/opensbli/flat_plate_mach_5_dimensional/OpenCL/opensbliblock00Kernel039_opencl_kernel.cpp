...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel039(OPS_instance *instance, int xdim0, int xdim1, int xdim2, int xdim3, int xdim4) {
      ...
      if(!isbuilt_opensbliblock00Kernel039) {
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel039 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel039=%d  -Dxdim1_opensbliblock00Kernel039=%d  -Dxdim2_opensbliblock00Kernel039=%d  -Dxdim3_opensbliblock00Kernel039=%d  -Dxdim4_opensbliblock00Kernel039=%d ", pPath, 32,xdim0,xdim1,xdim2,xdim3,xdim4);
            else
              sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel039=%d  -Dxdim1_opensbliblock00Kernel039=%d  -Dxdim2_opensbliblock00Kernel039=%d  -Dxdim3_opensbliblock00Kernel039=%d  -Dxdim4_opensbliblock00Kernel039=%d ", pPath, 32,xdim0,xdim1,xdim2,xdim3,xdim4);
          else {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[3] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel039", &ret);
        clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel039(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,3,"opensbliblock00Kernel039");
