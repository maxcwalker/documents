...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel033(OPS_instance *instance, int xdim0, int xdim1, int xdim2, int xdim3) {
      ...
      if(!isbuilt_opensbliblock00Kernel033) {
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel033 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel033=%d  -Dxdim1_opensbliblock00Kernel033=%d  -Dxdim2_opensbliblock00Kernel033=%d  -Dxdim3_opensbliblock00Kernel033=%d ", pPath, 32,xdim0,xdim1,xdim2,xdim3);
            else
              sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel033=%d  -Dxdim1_opensbliblock00Kernel033=%d  -Dxdim2_opensbliblock00Kernel033=%d  -Dxdim3_opensbliblock00Kernel033=%d ", pPath, 32,xdim0,xdim1,xdim2,xdim3);
          else {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[10] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel033", &ret);
        clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel033(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,10,"opensbliblock00Kernel033");
