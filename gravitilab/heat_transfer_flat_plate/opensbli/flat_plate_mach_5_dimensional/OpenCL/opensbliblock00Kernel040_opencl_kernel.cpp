...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel040(OPS_instance *instance, int xdim0, int xdim1, int xdim2, int xdim3, int xdim4) {
      ...
      if(!isbuilt_opensbliblock00Kernel040) {
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel040 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel040=%d  -Dxdim1_opensbliblock00Kernel040=%d  -Dxdim2_opensbliblock00Kernel040=%d  -Dxdim3_opensbliblock00Kernel040=%d  -Dxdim4_opensbliblock00Kernel040=%d ", pPath, 32,xdim0,xdim1,xdim2,xdim3,xdim4);
            else
              sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel040=%d  -Dxdim1_opensbliblock00Kernel040=%d  -Dxdim2_opensbliblock00Kernel040=%d  -Dxdim3_opensbliblock00Kernel040=%d  -Dxdim4_opensbliblock00Kernel040=%d ", pPath, 32,xdim0,xdim1,xdim2,xdim3,xdim4);
          else {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[4] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel040", &ret);
        clSafeCall( ret );
