...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel004(OPS_instance *instance, int xdim0, int xdim1) {
      ...
      if(!isbuilt_opensbliblock00Kernel004) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[20] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel004", &ret);
        clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel004(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,20,"opensbliblock00Kernel004");
