...
void ops_par_loop_opensbliblock00Kernel019_execute(ops_kernel_descriptor *desc) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,15,"opensbliblock00Kernel019");
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      const ACC<double> D10_B0(xdim0_opensbliblock00Kernel019, D10_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel019*1);
      const ACC<double> D11_B0(xdim1_opensbliblock00Kernel019, D11_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel019*1);
      const ACC<double> u0_B0(xdim2_opensbliblock00Kernel019, u0_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel019*1);
      const ACC<double> u1_B0(xdim3_opensbliblock00Kernel019, u1_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel019*1);
      ACC<double> U1_B0(xdim4_opensbliblock00Kernel019, U1_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel019*1);
...
void ops_par_loop_opensbliblock00Kernel019(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 15, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel019_execute);
}
#endif
