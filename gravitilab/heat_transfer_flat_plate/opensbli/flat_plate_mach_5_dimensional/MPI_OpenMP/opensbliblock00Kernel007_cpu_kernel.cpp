...
void ops_par_loop_opensbliblock00Kernel007_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      ACC<double> T_B0(xdim2_opensbliblock00Kernel007, T_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel007*1);
...
void ops_par_loop_opensbliblock00Kernel007(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  create_kerneldesc_and_enque(name, args, 3, 16, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel007_execute);
}
#endif
