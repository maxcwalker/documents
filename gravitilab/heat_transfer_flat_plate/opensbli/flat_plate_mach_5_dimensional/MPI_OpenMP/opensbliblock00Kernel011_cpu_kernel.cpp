...
void ops_par_loop_opensbliblock00Kernel011_execute(ops_kernel_descriptor *desc) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,25,"opensbliblock00Kernel011");
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      ACC<double> wk7_B0(xdim1_opensbliblock00Kernel011, wk7_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel011*1);
...
void ops_par_loop_opensbliblock00Kernel011(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  create_kerneldesc_and_enque(name, args, 3, 25, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel011_execute);
}
#endif
