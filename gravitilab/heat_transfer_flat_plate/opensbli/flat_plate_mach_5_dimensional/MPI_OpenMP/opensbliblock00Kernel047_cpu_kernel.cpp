...
void ops_par_loop_opensbliblock00Kernel047_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      const ACC<double> Residual0_B0(xdim0_opensbliblock00Kernel047, Residual0_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel047*1);
      const ACC<double> Residual1_B0(xdim1_opensbliblock00Kernel047, Residual1_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel047*1);
      const ACC<double> Residual2_B0(xdim2_opensbliblock00Kernel047, Residual2_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel047*1);
      const ACC<double> Residual3_B0(xdim3_opensbliblock00Kernel047, Residual3_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel047*1);
      ACC<double> rhoE_B0(xdim4_opensbliblock00Kernel047, rhoE_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel047*1);
      ACC<double> rhoE_RKold_B0(xdim5_opensbliblock00Kernel047, rhoE_RKold_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel047*1);
      ACC<double> rho_B0(xdim6_opensbliblock00Kernel047, rho_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel047*1);
      ACC<double> rho_RKold_B0(xdim7_opensbliblock00Kernel047, rho_RKold_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel047*1);
      ACC<double> rhou0_B0(xdim8_opensbliblock00Kernel047, rhou0_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel047*1);
      ACC<double> rhou0_RKold_B0(xdim9_opensbliblock00Kernel047, rhou0_RKold_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel047*1);
      ACC<double> rhou1_B0(xdim10_opensbliblock00Kernel047, rhou1_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel047*1);
      ACC<double> rhou1_RKold_B0(xdim11_opensbliblock00Kernel047, rhou1_RKold_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel047*1);
...
void ops_par_loop_opensbliblock00Kernel047(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13) {
  ...
  create_kerneldesc_and_enque(name, args, 14, 28, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel047_execute);
}
#endif
