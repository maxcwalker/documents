...
void ops_par_loop_opensbliblock00Kernel008_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      ACC<double> wk4_B0(xdim1_opensbliblock00Kernel008, wk4_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel008*1);
...
void ops_par_loop_opensbliblock00Kernel008(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  create_kerneldesc_and_enque(name, args, 3, 22, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel008_execute);
}
#endif
