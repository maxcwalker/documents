...
void ops_par_loop_opensbliblock00Kernel040_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ACC<double> D00_B0(xdim0_opensbliblock00Kernel040, D00_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel040*1);
      ACC<double> D01_B0(xdim1_opensbliblock00Kernel040, D01_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel040*1);
      ACC<double> D10_B0(xdim2_opensbliblock00Kernel040, D10_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel040*1);
      ACC<double> D11_B0(xdim3_opensbliblock00Kernel040, D11_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel040*1);
      ACC<double> detJ_B0(xdim4_opensbliblock00Kernel040, detJ_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel040*1);
...
void ops_par_loop_opensbliblock00Kernel040(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 4, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel040_execute);
}
#endif
