...
void ops_par_loop_opensbliblock00Kernel008_execute(ops_kernel_descriptor *desc) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,22,"opensbliblock00Kernel008");
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> u0_B0(xdim0_opensbliblock00Kernel008, &u0_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel008*1);
        ACC<double> wk4_B0(xdim1_opensbliblock00Kernel008, &wk4_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel008*1);
        //USER CODE
