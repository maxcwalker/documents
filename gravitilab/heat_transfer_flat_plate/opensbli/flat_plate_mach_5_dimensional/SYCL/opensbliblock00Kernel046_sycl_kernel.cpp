  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> D00_B0(xdim0_opensbliblock00Kernel046, &D00_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel046*1);
        const ACC<double> D01_B0(xdim1_opensbliblock00Kernel046, &D01_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel046*1);
        const ACC<double> D10_B0(xdim2_opensbliblock00Kernel046, &D10_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel046*1);
        const ACC<double> D11_B0(xdim3_opensbliblock00Kernel046, &D11_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel046*1);
        ACC<double> SD000_B0(xdim4_opensbliblock00Kernel046, &SD000_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel046*1);
        ACC<double> SD001_B0(xdim5_opensbliblock00Kernel046, &SD001_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel046*1);
        ACC<double> SD010_B0(xdim6_opensbliblock00Kernel046, &SD010_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel046*1);
        ACC<double> SD011_B0(xdim7_opensbliblock00Kernel046, &SD011_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel046*1);
        ACC<double> SD100_B0(xdim8_opensbliblock00Kernel046, &SD100_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel046*1);
        ACC<double> SD101_B0(xdim9_opensbliblock00Kernel046, &SD101_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel046*1);
        ACC<double> SD110_B0(xdim10_opensbliblock00Kernel046, &SD110_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel046*1);
        ACC<double> SD111_B0(xdim11_opensbliblock00Kernel046, &SD111_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel046*1);
        //USER CODE
