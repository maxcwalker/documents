  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> Residual0_B0(xdim0_opensbliblock00Kernel047, &Residual0_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel047*1);
        const ACC<double> Residual1_B0(xdim1_opensbliblock00Kernel047, &Residual1_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel047*1);
        const ACC<double> Residual2_B0(xdim2_opensbliblock00Kernel047, &Residual2_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel047*1);
        const ACC<double> Residual3_B0(xdim3_opensbliblock00Kernel047, &Residual3_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel047*1);
        ACC<double> rhoE_B0(xdim4_opensbliblock00Kernel047, &rhoE_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel047*1);
        ACC<double> rhoE_RKold_B0(xdim5_opensbliblock00Kernel047, &rhoE_RKold_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel047*1);
        ACC<double> rho_B0(xdim6_opensbliblock00Kernel047, &rho_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel047*1);
        ACC<double> rho_RKold_B0(xdim7_opensbliblock00Kernel047, &rho_RKold_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel047*1);
        ACC<double> rhou0_B0(xdim8_opensbliblock00Kernel047, &rhou0_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel047*1);
        ACC<double> rhou0_RKold_B0(xdim9_opensbliblock00Kernel047, &rhou0_RKold_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel047*1);
        ACC<double> rhou1_B0(xdim10_opensbliblock00Kernel047, &rhou1_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel047*1);
        ACC<double> rhou1_RKold_B0(xdim11_opensbliblock00Kernel047, &rhou1_RKold_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel047*1);
