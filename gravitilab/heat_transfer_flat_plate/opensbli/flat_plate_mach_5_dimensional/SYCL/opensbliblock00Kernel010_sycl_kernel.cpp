  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> u2_B0(xdim0_opensbliblock00Kernel010, &u2_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel010*1);
        ACC<double> wk6_B0(xdim1_opensbliblock00Kernel010, &wk6_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel010*1);
        //USER CODE
