  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        ACC<double> D00_B0(xdim0_opensbliblock00Kernel041, &D00_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel041*1);
        ACC<double> D01_B0(xdim1_opensbliblock00Kernel041, &D01_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel041*1);
        ACC<double> D10_B0(xdim2_opensbliblock00Kernel041, &D10_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel041*1);
        ACC<double> D11_B0(xdim3_opensbliblock00Kernel041, &D11_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel041*1);
        ACC<double> detJ_B0(xdim4_opensbliblock00Kernel041, &detJ_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel041*1);
        //USER CODE
