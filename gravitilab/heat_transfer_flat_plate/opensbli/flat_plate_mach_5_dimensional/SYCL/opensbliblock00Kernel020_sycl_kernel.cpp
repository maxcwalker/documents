  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> D10_B0(xdim0_opensbliblock00Kernel020, &D10_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel020*1);
        const ACC<double> D11_B0(xdim1_opensbliblock00Kernel020, &D11_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel020*1);
        ...
        ACC<double> U1_B0(xdim4_opensbliblock00Kernel020, &U1_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel020*1);
        //USER CODE
