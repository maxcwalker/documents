  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> D00_B0(xdim0_opensbliblock00Kernel015, &D00_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel015*1);
        const ACC<double> D01_B0(xdim1_opensbliblock00Kernel015, &D01_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel015*1);
        ...
        ACC<double> U0_B0(xdim4_opensbliblock00Kernel015, &U0_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel015*1);
        //USER CODE
