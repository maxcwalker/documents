...
void opensbliblock00Kernel046_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      const ptr_double D00_B0 = { D00_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel046*1, xdim0_opensbliblock00Kernel046};
      const ptr_double D01_B0 = { D01_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel046*1, xdim1_opensbliblock00Kernel046};
      const ptr_double D10_B0 = { D10_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel046*1, xdim2_opensbliblock00Kernel046};
      const ptr_double D11_B0 = { D11_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel046*1, xdim3_opensbliblock00Kernel046};
      ptr_double SD000_B0 = { SD000_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel046*1, xdim4_opensbliblock00Kernel046};
      ptr_double SD001_B0 = { SD001_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel046*1, xdim5_opensbliblock00Kernel046};
      ptr_double SD010_B0 = { SD010_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel046*1, xdim6_opensbliblock00Kernel046};
      ptr_double SD011_B0 = { SD011_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel046*1, xdim7_opensbliblock00Kernel046};
      ptr_double SD100_B0 = { SD100_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel046*1, xdim8_opensbliblock00Kernel046};
      ptr_double SD101_B0 = { SD101_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel046*1, xdim9_opensbliblock00Kernel046};
      ptr_double SD110_B0 = { SD110_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel046*1, xdim10_opensbliblock00Kernel046};
      ptr_double SD111_B0 = { SD111_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel046*1, xdim11_opensbliblock00Kernel046};
