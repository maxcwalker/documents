...
void opensbliblock00Kernel037_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    ...
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      ptr_double ptr4 = {  p_a4 + n_x*1*1 + n_y*xdim4_opensbliblock00Kernel037*1*1, xdim4_opensbliblock00Kernel037};
      ptr_double ptr5 = {  p_a5 + n_x*1*1 + n_y*xdim5_opensbliblock00Kernel037*1*1, xdim5_opensbliblock00Kernel037};
      ptr_double ptr6 = {  p_a6 + n_x*1*1 + n_y*xdim6_opensbliblock00Kernel037*1*1, xdim6_opensbliblock00Kernel037};
      ptr_double ptr7 = {  p_a7 + n_x*1*1 + n_y*xdim7_opensbliblock00Kernel037*1*1, xdim7_opensbliblock00Kernel037};
      ptr_double ptr8 = {  p_a8 + n_x*1*1 + n_y*xdim8_opensbliblock00Kernel037*1*1, xdim8_opensbliblock00Kernel037};
