...
void ops_par_loop_opensbliblock00Kernel015_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start1; n_y<end1; n_y++ ){
    for ( int n_x=start0; n_x<end0; n_x++ ){
      const ACC<double> D00_B0(xdim0_opensbliblock00Kernel015, D00_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel015*1);
      const ACC<double> D01_B0(xdim1_opensbliblock00Kernel015, D01_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel015*1);
      ...
      ACC<double> U0_B0(xdim4_opensbliblock00Kernel015, U0_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel015*1);
...
void ops_par_loop_opensbliblock00Kernel015(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 14, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel015_execute);
}
#endif
