...
void ops_par_loop_opensbliblock00Kernel016_execute(ops_kernel_descriptor *desc) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,14,"opensbliblock00Kernel016");
  ...
  for ( int n_y=start1; n_y<end1; n_y++ ){
    for ( int n_x=start0; n_x<end0; n_x++ ){
      const ACC<double> D00_B0(xdim0_opensbliblock00Kernel016, D00_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel016*1);
      const ACC<double> D01_B0(xdim1_opensbliblock00Kernel016, D01_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel016*1);
      ...
      ACC<double> U0_B0(xdim4_opensbliblock00Kernel016, U0_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel016*1);
...
void ops_par_loop_opensbliblock00Kernel016(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 14, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel016_execute);
}
#endif
