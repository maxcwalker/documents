...
void ops_par_loop_opensbliblock00Kernel034_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start1; n_y<end1; n_y++ ){
    for ( int n_x=start0; n_x<end0; n_x++ ){
      ...
      ACC<double> rhoE_B0(xdim0_opensbliblock00Kernel034, rhoE_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel034*1);
      ACC<double> rho_B0(xdim1_opensbliblock00Kernel034, rho_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel034*1);
      ACC<double> rhou0_B0(xdim2_opensbliblock00Kernel034, rhou0_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel034*1);
      ACC<double> rhou1_B0(xdim3_opensbliblock00Kernel034, rhou1_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel034*1);
      ACC<double> x0_B0(xdim4_opensbliblock00Kernel034, x0_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel034*1);
      ACC<double> x1_B0(xdim5_opensbliblock00Kernel034, x1_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel034*1);
...
void ops_par_loop_opensbliblock00Kernel034(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6) {
  ...
  create_kerneldesc_and_enque(name, args, 7, 0, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel034_execute);
}
#endif
