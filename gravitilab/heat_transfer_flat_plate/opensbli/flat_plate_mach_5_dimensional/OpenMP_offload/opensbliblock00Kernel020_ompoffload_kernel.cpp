...
void ops_par_loop_opensbliblock00Kernel020_execute(ops_kernel_descriptor *desc) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,15,"opensbliblock00Kernel020");
  ...
  for ( int n_y=start1; n_y<end1; n_y++ ){
    for ( int n_x=start0; n_x<end0; n_x++ ){
      const ACC<double> D10_B0(xdim0_opensbliblock00Kernel020, D10_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel020*1);
      const ACC<double> D11_B0(xdim1_opensbliblock00Kernel020, D11_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel020*1);
      ...
      ACC<double> U1_B0(xdim4_opensbliblock00Kernel020, U1_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel020*1);
...
void ops_par_loop_opensbliblock00Kernel020(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 15, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel020_execute);
}
#endif
