...
void ops_par_loop_opensbliblock00Kernel021_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start1; n_y<end1; n_y++ ){
    for ( int n_x=start0; n_x<end0; n_x++ ){
      ...
      const ACC<double> D00_B0(xdim0_opensbliblock00Kernel021, D00_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel021*1);
      const ACC<double> D01_B0(xdim1_opensbliblock00Kernel021, D01_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel021*1);
      const ACC<double> D10_B0(xdim2_opensbliblock00Kernel021, D10_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel021*1);
      const ACC<double> D11_B0(xdim3_opensbliblock00Kernel021, D11_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel021*1);
      const ACC<double> SD000_B0(xdim4_opensbliblock00Kernel021, SD000_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel021*1);
      const ACC<double> SD001_B0(xdim5_opensbliblock00Kernel021, SD001_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel021*1);
      const ACC<double> SD010_B0(xdim6_opensbliblock00Kernel021, SD010_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel021*1);
      const ACC<double> SD011_B0(xdim7_opensbliblock00Kernel021, SD011_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel021*1);
      const ACC<double> SD100_B0(xdim8_opensbliblock00Kernel021, SD100_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel021*1);
      const ACC<double> SD101_B0(xdim9_opensbliblock00Kernel021, SD101_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel021*1);
      const ACC<double> SD110_B0(xdim10_opensbliblock00Kernel021, SD110_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel021*1);
      const ACC<double> SD111_B0(xdim11_opensbliblock00Kernel021, SD111_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel021*1);
      const ACC<double> T_B0(xdim12_opensbliblock00Kernel021, T_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel021*1);
      const ACC<double> mu_B0(xdim13_opensbliblock00Kernel021, mu_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel021*1);
      const ACC<double> u0_B0(xdim14_opensbliblock00Kernel021, u0_B0_p + n_x*1 + n_y * xdim14_opensbliblock00Kernel021*1);
      const ACC<double> u1_B0(xdim15_opensbliblock00Kernel021, u1_B0_p + n_x*1 + n_y * xdim15_opensbliblock00Kernel021*1);
      const ACC<double> wk0_B0(xdim16_opensbliblock00Kernel021, wk0_B0_p + n_x*1 + n_y * xdim16_opensbliblock00Kernel021*1);
      const ACC<double> wk1_B0(xdim17_opensbliblock00Kernel021, wk1_B0_p + n_x*1 + n_y * xdim17_opensbliblock00Kernel021*1);
      const ACC<double> wk3_B0(xdim18_opensbliblock00Kernel021, wk3_B0_p + n_x*1 + n_y * xdim18_opensbliblock00Kernel021*1);
      const ACC<double> wk4_B0(xdim19_opensbliblock00Kernel021, wk4_B0_p + n_x*1 + n_y * xdim19_opensbliblock00Kernel021*1);
      const ACC<double> wk5_B0(xdim20_opensbliblock00Kernel021, wk5_B0_p + n_x*1 + n_y * xdim20_opensbliblock00Kernel021*1);
      const ACC<double> wk7_B0(xdim21_opensbliblock00Kernel021, wk7_B0_p + n_x*1 + n_y * xdim21_opensbliblock00Kernel021*1);
      ACC<double> Residual1_B0(xdim22_opensbliblock00Kernel021, Residual1_B0_p + n_x*1 + n_y * xdim22_opensbliblock00Kernel021*1);
      ACC<double> Residual2_B0(xdim23_opensbliblock00Kernel021, Residual2_B0_p + n_x*1 + n_y * xdim23_opensbliblock00Kernel021*1);
      ACC<double> Residual3_B0(xdim24_opensbliblock00Kernel021, Residual3_B0_p + n_x*1 + n_y * xdim24_opensbliblock00Kernel021*1);
   ...
   if (idx[1] == 0){
    ...
    Residual3_B0(0,0) = 0.26*((D00_B0(0,0)*D00_B0(0,0))*d2_T_dx + (D01_B0(0,0)*D01_B0(0,0))*d2_T_dx +
      ...
      2*D01_B0(0,0)*D11_B0(0,0)*d1_wk3_dy)*invRe + (D00_B0(0,0)*wk1_B0(0,0) +
      D10_B0(0,0)*wk5_B0(0,0))*(D00_B0(0,0)*wk1_B0(0,0) + D01_B0(0,0)*wk0_B0(0,0) + D10_B0(0,0)*wk5_B0(0,0) +
      D11_B0(0,0)*wk4_B0(0,0))*invRe*mu_B0(0,0) + (D00_B0(0,0)*d1_mu_dx + D10_B0(0,0)*d1_mu_dy)*(D00_B0(0,0)*wk1_B0(0,0)
      + D01_B0(0,0)*wk0_B0(0,0) + D10_B0(0,0)*wk5_B0(0,0) + D11_B0(0,0)*wk4_B0(0,0))*invRe*u1_B0(0,0) +
      (D01_B0(0,0)*wk0_B0(0,0) + D11_B0(0,0)*wk4_B0(0,0))*(D00_B0(0,0)*wk1_B0(0,0) + D01_B0(0,0)*wk0_B0(0,0) +
      D10_B0(0,0)*wk5_B0(0,0) + D11_B0(0,0)*wk4_B0(0,0))*invRe*mu_B0(0,0) + (D01_B0(0,0)*d1_mu_dx +
      D11_B0(0,0)*d1_mu_dy)*(D00_B0(0,0)*wk1_B0(0,0) + D01_B0(0,0)*wk0_B0(0,0) + D10_B0(0,0)*wk5_B0(0,0) +
      D11_B0(0,0)*wk4_B0(0,0))*invRe*u0_B0(0,0) - (2.0/3.0)*(D01_B0(0,0)*wk1_B0(0,0) +
      D11_B0(0,0)*wk5_B0(0,0))*(D00_B0(0,0)*wk0_B0(0,0) + D10_B0(0,0)*wk4_B0(0,0) - 2*D01_B0(0,0)*wk1_B0(0,0) -
      2*D11_B0(0,0)*wk5_B0(0,0))*invRe*mu_B0(0,0) - (2.0/3.0)*(D01_B0(0,0)*d1_mu_dx +
      D11_B0(0,0)*d1_mu_dy)*(D00_B0(0,0)*wk0_B0(0,0) + D10_B0(0,0)*wk4_B0(0,0) - 2*D01_B0(0,0)*wk1_B0(0,0) -
      ...
      2*D00_B0(0,0)*wk0_B0(0,0) + 2*D10_B0(0,0)*wk4_B0(0,0))*invRe*u0_B0(0,0) + Residual3_B0(0,0);
...
void ops_par_loop_opensbliblock00Kernel021(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg24, ops_arg arg25) {
  ...
  create_kerneldesc_and_enque(name, args, 26, 25, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel021_execute);
}
#endif
