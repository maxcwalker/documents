...
void ops_par_loop_opensbliblock00Kernel014_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start1; n_y<end1; n_y++ ){
    for ( int n_x=start0; n_x<end0; n_x++ ){
      const ACC<double> rhoE_B0(xdim0_opensbliblock00Kernel014, rhoE_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel014*1);
      const ACC<double> rho_B0(xdim1_opensbliblock00Kernel014, rho_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel014*1);
      ...
      ACC<double> p_B0(xdim4_opensbliblock00Kernel014, p_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel014*1);
...
void ops_par_loop_opensbliblock00Kernel014(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 13, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel014_execute);
}
#endif
