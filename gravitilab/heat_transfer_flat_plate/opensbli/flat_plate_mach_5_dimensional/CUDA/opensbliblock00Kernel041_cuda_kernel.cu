...
//
__constant__ int dims_opensbliblock00Kernel041 [5][1];
static int dims_opensbliblock00Kernel041_h [5][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel041_gpu(ACC<double> &D00_B0,
  ACC<double> &D01_B0,
  ACC<double> &D10_B0,
  ACC<double> &D11_B0,
  ACC<double> &detJ_B0)
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ACC<double> argp0(dims_opensbliblock00Kernel041[0][0], arg0);
    ACC<double> argp1(dims_opensbliblock00Kernel041[1][0], arg1);
    ACC<double> argp2(dims_opensbliblock00Kernel041[2][0], arg2);
    ACC<double> argp3(dims_opensbliblock00Kernel041[3][0], arg3);
    ACC<double> argp4(dims_opensbliblock00Kernel041[4][0], arg4);
...
void ops_par_loop_opensbliblock00Kernel041_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel041_h[0][0] || xdim1 != dims_opensbliblock00Kernel041_h[1][0] || xdim2 != dims_opensbliblock00Kernel041_h[2][0] || xdim3 != dims_opensbliblock00Kernel041_h[3][0] || xdim4 != dims_opensbliblock00Kernel041_h[4][0]) {
...
void ops_par_loop_opensbliblock00Kernel041(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 5, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel041_execute);
}
#endif
