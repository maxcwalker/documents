...
//
__constant__ int dims_opensbliblock00Kernel021 [26][1];
static int dims_opensbliblock00Kernel021_h [26][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel021_gpu(const ACC<double> &D00_B0,
...
int size1 ){
  ...
  arg19 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel021[19][0];
  arg20 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel021[20][0];
  arg21 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel021[21][0];
  arg22 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel021[22][0];
  arg23 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel021[23][0];
  arg24 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel021[24][0];
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    const ACC<double> argp15(dims_opensbliblock00Kernel021[15][0], arg15);
    const ACC<double> argp16(dims_opensbliblock00Kernel021[16][0], arg16);
    const ACC<double> argp17(dims_opensbliblock00Kernel021[17][0], arg17);
    const ACC<double> argp18(dims_opensbliblock00Kernel021[18][0], arg18);
    const ACC<double> argp19(dims_opensbliblock00Kernel021[19][0], arg19);
    const ACC<double> argp20(dims_opensbliblock00Kernel021[20][0], arg20);
    const ACC<double> argp21(dims_opensbliblock00Kernel021[21][0], arg21);
    ACC<double> argp22(dims_opensbliblock00Kernel021[22][0], arg22);
    ACC<double> argp23(dims_opensbliblock00Kernel021[23][0], arg23);
    ACC<double> argp24(dims_opensbliblock00Kernel021[24][0], arg24);
...
void ops_par_loop_opensbliblock00Kernel021_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel021_h[0][0] || xdim1 != dims_opensbliblock00Kernel021_h[1][0] || xdim2 != dims_opensbliblock00Kernel021_h[2][0] || xdim3 != dims_opensbliblock00Kernel021_h[3][0] || xdim4 != dims_opensbliblock00Kernel021_h[4][0] || xdim5 != dims_opensbliblock00Kernel021_h[5][0] || xdim6 != dims_opensbliblock00Kernel021_h[6][0] || xdim7 != dims_opensbliblock00Kernel021_h[7][0] || xdim8 != dims_opensbliblock00Kernel021_h[8][0] || xdim9 != dims_opensbliblock00Kernel021_h[9][0] || xdim10 != dims_opensbliblock00Kernel021_h[10][0] || xdim11 != dims_opensbliblock00Kernel021_h[11][0] || xdim12 != dims_opensbliblock00Kernel021_h[12][0] || xdim13 != dims_opensbliblock00Kernel021_h[13][0] || xdim14 != dims_opensbliblock00Kernel021_h[14][0] || xdim15 != dims_opensbliblock00Kernel021_h[15][0] || xdim16 != dims_opensbliblock00Kernel021_h[16][0] || xdim17 != dims_opensbliblock00Kernel021_h[17][0] || xdim18 != dims_opensbliblock00Kernel021_h[18][0] || xdim19 != dims_opensbliblock00Kernel021_h[19][0] || xdim20 != dims_opensbliblock00Kernel021_h[20][0] || xdim21 != dims_opensbliblock00Kernel021_h[21][0] || xdim22 != dims_opensbliblock00Kernel021_h[22][0] || xdim23 != dims_opensbliblock00Kernel021_h[23][0] || xdim24 != dims_opensbliblock00Kernel021_h[24][0]) {
    ...
    dims_opensbliblock00Kernel021_h[21][0] = xdim21;
    dims_opensbliblock00Kernel021_h[22][0] = xdim22;
    dims_opensbliblock00Kernel021_h[23][0] = xdim23;
    dims_opensbliblock00Kernel021_h[24][0] = xdim24;
...
void ops_par_loop_opensbliblock00Kernel021(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg24, ops_arg arg25) {
  ...
  create_kerneldesc_and_enque(name, args, 26, 25, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel021_execute);
}
#endif
