...
//
__constant__ int dims_opensbliblock00Kernel037 [12][1];
static int dims_opensbliblock00Kernel037_h [12][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel037_gpu(const ACC<double> &x0_B0,
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp4(dims_opensbliblock00Kernel037[4][0], arg4);
    ACC<double> argp5(dims_opensbliblock00Kernel037[5][0], arg5);
    ACC<double> argp6(dims_opensbliblock00Kernel037[6][0], arg6);
    ACC<double> argp7(dims_opensbliblock00Kernel037[7][0], arg7);
    ACC<double> argp8(dims_opensbliblock00Kernel037[8][0], arg8);
...
void ops_par_loop_opensbliblock00Kernel037(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10, ops_arg arg11) {
  ...
  create_kerneldesc_and_enque(name, args, 12, 1, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel037_execute);
}
#endif
