...
//
__constant__ int dims_opensbliblock00Kernel046 [13][1];
static int dims_opensbliblock00Kernel046_h [13][1] = {{0}};
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp4(dims_opensbliblock00Kernel046[4][0], arg4);
    ACC<double> argp5(dims_opensbliblock00Kernel046[5][0], arg5);
    ACC<double> argp6(dims_opensbliblock00Kernel046[6][0], arg6);
    ACC<double> argp7(dims_opensbliblock00Kernel046[7][0], arg7);
    ACC<double> argp8(dims_opensbliblock00Kernel046[8][0], arg8);
    ACC<double> argp9(dims_opensbliblock00Kernel046[9][0], arg9);
...
void ops_par_loop_opensbliblock00Kernel046(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12) {
  ...
  create_kerneldesc_and_enque(name, args, 13, 6, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel046_execute);
}
#endif
