...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel019(OPS_instance *instance, int xdim0, int xdim1) {
      ...
      if(!isbuilt_opensbliblock00Kernel019) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[24] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel019", &ret);
        clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel019(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,24,"opensbliblock00Kernel019");
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[24], 2, sizeof(cl_int), (void*) &block0np1 ));
