...
int stencil_0_01temp[] = {-4, 0, -3, 0, -2, 0, -1, 0, 0, -4, 0, -3, 0, -2, 0, -1, 0, 0, 0, 1, 0, 2, 0, 3, 0, 4, 1, 0, 2, 0, 3, 0, 4, 0};
ops_stencil stencil_0_01 = ops_decl_stencil(2,17,stencil_0_01temp,"stencil_0_01temp");
// Init OPS partition
ops_partition("");
...
ops_arg_dat(theta_B0, 1, stencil_0_00, "double", OPS_WRITE),
ops_arg_idx());


int iteration_range_11_block0[] = {-3, block0np0 + 4, -3, block0np1 + 4};
ops_par_loop(opensbliblock00Kernel011, "CRp", opensbliblock00, 2, iteration_range_11_block0,
...
ops_arg_dat(theta_B0, 1, stencil_0_00, "double", OPS_READ),
...
ops_arg_dat(TENO_B0, 1, stencil_0_00, "double", OPS_WRITE),
