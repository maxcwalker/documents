  ...
  ptr_double wk5_B0, const double eps, const double gama, const double gamma_m1, const double teno_a1, const double teno_a2, const double rc8, const double rc11, const double rc13, const double rc15, const double rc16, const double rc17, const double rc18, const double rc19, const double rc20, const double rc21, const double rc22, const double rc23, const double rcinv24)
{
   ...
   CS_15 = AVG_1_1_LEV_10*OPS_ACCS(rho_B0, 0,3) + AVG_1_1_LEV_11*OPS_ACCS(rhou0_B0, 0,3);
    ...
    max_lambda_1_00 = fmax(fabs(OPS_ACCS(u1_B0, 0,3)), fmax(fabs(OPS_ACCS(u1_B0, 0,-2)),
      fmax(fabs(OPS_ACCS(u1_B0, 0,2)), fmax(fabs(OPS_ACCS(u1_B0, 0,1)), fmax(fabs(OPS_ACCS(u1_B0, 0,0)),
      fabs(OPS_ACCS(u1_B0, 0,-1)))))));

   max_lambda_1_11 = max_lambda_1_00;

    max_lambda_1_22 = fmax(fabs(OPS_ACCS(a_B0, 0,1) + OPS_ACCS(u1_B0, 0,1)), fmax(fabs(OPS_ACCS(a_B0, 0,0) +
      OPS_ACCS(u1_B0, 0,0)), fmax(fabs(OPS_ACCS(a_B0, 0,3) + OPS_ACCS(u1_B0, 0,3)), fmax(fabs(OPS_ACCS(a_B0, 0,2) +
      OPS_ACCS(u1_B0, 0,2)), fmax(fabs(OPS_ACCS(a_B0, 0,-1) + OPS_ACCS(u1_B0, 0,-1)), fabs(OPS_ACCS(a_B0, 0,-2) +
      OPS_ACCS(u1_B0, 0,-2)))))));

    max_lambda_1_33 = fmax(fabs(OPS_ACCS(a_B0, 0,2) - OPS_ACCS(u1_B0, 0,2)), fmax(fabs(OPS_ACCS(a_B0, 0,0) -
      OPS_ACCS(u1_B0, 0,0)), fmax(fabs(OPS_ACCS(a_B0, 0,3) - OPS_ACCS(u1_B0, 0,3)), fmax(fabs(OPS_ACCS(a_B0, 0,-2) -
      OPS_ACCS(u1_B0, 0,-2)), fmax(fabs(OPS_ACCS(a_B0, 0,1) - OPS_ACCS(u1_B0, 0,1)), fabs(OPS_ACCS(a_B0, 0,-1) -
      OPS_ACCS(u1_B0, 0,-1)))))));
