...
//user function
 ...
 void opensbliblock00Kernel003(const ptr_double theta_B0,
  ...
  ptr_double wk2_B0, const double eps, const double gama, const double gamma_m1, const double teno_a1, const double teno_a2, const double rc8, const double rc11, const double rc13, const double rc15, const double rc16, const double rc17, const double rc18, const double rc19, const double rc20, const double rc21, const double rc22, const double rc23, const double rcinv24)
{
   ...
   CS_15 = AVG_0_0_LEV_10*OPS_ACCS(rho_B0, 3,0) + AVG_0_0_LEV_12*OPS_ACCS(rhou1_B0, 3,0);
    ...
    max_lambda_0_00 = fmax(fabs(OPS_ACCS(u0_B0, 2,0)), fmax(fabs(OPS_ACCS(u0_B0, 0,0)),
      fmax(fabs(OPS_ACCS(u0_B0, -2,0)), fmax(fabs(OPS_ACCS(u0_B0, -1,0)), fmax(fabs(OPS_ACCS(u0_B0, 3,0)),
      fabs(OPS_ACCS(u0_B0, 1,0)))))));

   max_lambda_0_11 = max_lambda_0_00;

    max_lambda_0_22 = fmax(fabs(OPS_ACCS(a_B0, 2,0) + OPS_ACCS(u0_B0, 2,0)), fmax(fabs(OPS_ACCS(a_B0, -2,0) +
      OPS_ACCS(u0_B0, -2,0)), fmax(fabs(OPS_ACCS(a_B0, 1,0) + OPS_ACCS(u0_B0, 1,0)), fmax(fabs(OPS_ACCS(a_B0, -1,0) +
      OPS_ACCS(u0_B0, -1,0)), fmax(fabs(OPS_ACCS(a_B0, 0,0) + OPS_ACCS(u0_B0, 0,0)), fabs(OPS_ACCS(a_B0, 3,0) +
      OPS_ACCS(u0_B0, 3,0)))))));

    max_lambda_0_33 = fmax(fabs(OPS_ACCS(a_B0, -2,0) - OPS_ACCS(u0_B0, -2,0)), fmax(fabs(OPS_ACCS(a_B0, 2,0) -
      OPS_ACCS(u0_B0, 2,0)), fmax(fabs(OPS_ACCS(a_B0, 3,0) - OPS_ACCS(u0_B0, 3,0)), fmax(fabs(OPS_ACCS(a_B0, 1,0) -
      OPS_ACCS(u0_B0, 1,0)), fmax(fabs(OPS_ACCS(a_B0, -1,0) - OPS_ACCS(u0_B0, -1,0)), fabs(OPS_ACCS(a_B0, 0,0) -
      OPS_ACCS(u0_B0, 0,0)))))));
