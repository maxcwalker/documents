...
void ops_par_loop_opensbliblock00Kernel004_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ theta_B0_p = (double *)(args[0].data + base0);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      const ACC<double> theta_B0(xdim0_opensbliblock00Kernel004, theta_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel004*1);
      const ACC<double> rhoE_B0(xdim1_opensbliblock00Kernel004, rhoE_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel004*1);
      const ACC<double> rho_B0(xdim2_opensbliblock00Kernel004, rho_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel004*1);
      const ACC<double> p_B0(xdim3_opensbliblock00Kernel004, p_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel004*1);
      const ACC<double> rhou1_B0(xdim4_opensbliblock00Kernel004, rhou1_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel004*1);
      const ACC<double> a_B0(xdim5_opensbliblock00Kernel004, a_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel004*1);
      const ACC<double> rhou0_B0(xdim6_opensbliblock00Kernel004, rhou0_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel004*1);
      ...
      ACC<double> wk4_B0(xdim11_opensbliblock00Kernel004, wk4_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel004*1);
   ...
   CS_15 = AVG_1_1_LEV_10*rho_B0(0,3) + AVG_1_1_LEV_11*rhou0_B0(0,3);
    ...
    max_lambda_1_00 = fmax(fabs(u1_B0(0,3)), fmax(fabs(u1_B0(0,-2)),
      fmax(fabs(u1_B0(0,2)), fmax(fabs(u1_B0(0,1)), fmax(fabs(u1_B0(0,0)),
      fabs(u1_B0(0,-1)))))));

   max_lambda_1_11 = max_lambda_1_00;

    max_lambda_1_22 = fmax(fabs(a_B0(0,1) + u1_B0(0,1)), fmax(fabs(a_B0(0,0) +
      u1_B0(0,0)), fmax(fabs(a_B0(0,3) + u1_B0(0,3)), fmax(fabs(a_B0(0,2) +
      u1_B0(0,2)), fmax(fabs(a_B0(0,-1) + u1_B0(0,-1)), fabs(a_B0(0,-2) +
      u1_B0(0,-2)))))));

    max_lambda_1_33 = fmax(fabs(a_B0(0,2) - u1_B0(0,2)), fmax(fabs(a_B0(0,0) -
      u1_B0(0,0)), fmax(fabs(a_B0(0,3) - u1_B0(0,3)), fmax(fabs(a_B0(0,-2) -
      u1_B0(0,-2)), fmax(fabs(a_B0(0,1) - u1_B0(0,1)), fabs(a_B0(0,-1) -
      u1_B0(0,-1)))))));
