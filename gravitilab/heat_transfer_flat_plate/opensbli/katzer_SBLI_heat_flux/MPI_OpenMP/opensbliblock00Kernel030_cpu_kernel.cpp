...
void ops_par_loop_opensbliblock00Kernel030_execute(ops_kernel_descriptor *desc) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,21,"opensbliblock00Kernel030");
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    wk7_B0(0,0) = ((idx[0] == 0) ? (
   inv_1*((rc10)*T_B0(3,0) + 4*T_B0(1,0) -
      rc8*T_B0(4,0) - 3*T_B0(2,0) - rc9*T_B0(0,0))
)
: ((idx[0] == 1) ? (

      (rc11)*inv_1*(T_B0(3,0) - 3*T_B0(-1,0) + 18*T_B0(1,0) - 6*T_B0(2,0) -
      10*T_B0(0,0))
)
: ((idx[0] == block0np0 - 1) ? (
   inv_1*(-4*T_B0(-1,0) +
      (rc8)*T_B0(-4,0) + (rc9)*T_B0(0,0) - rc10*T_B0(-3,0) + 3*T_B0(-2,0))
)
:
      ((idx[0] == block0np0 - 2) ? (
   (rc11)*inv_1*(-18*T_B0(-1,0) + 3*T_B0(1,0) +
      10*T_B0(0,0) - T_B0(-3,0) + 6*T_B0(-2,0))
)
: (

      (rc11)*inv_1*(-8*T_B0(-1,0) + 8*T_B0(1,0) - T_B0(2,0) +
      T_B0(-2,0))
)))));
