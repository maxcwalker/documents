...
void ops_par_loop_opensbliblock00Kernel025_execute(ops_kernel_descriptor *desc) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,22,"opensbliblock00Kernel025");
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
   ...
   inv_0*(4*u2_B0(0,1) - rc9*u2_B0(0,0) +
      (rc10)*u2_B0(0,3) - 3*u2_B0(0,2) - rc8*u2_B0(0,4))
)
: ((idx[1] == 1) ? (

      (rc11)*inv_0*(18*u2_B0(0,1) - 10*u2_B0(0,0) + u2_B0(0,3) - 6*u2_B0(0,2) -
      3*u2_B0(0,-1))
)
: ((idx[1] == block0np1 - 1) ? (
   inv_0*((rc9)*u2_B0(0,0) +
      3*u2_B0(0,-2) - rc10*u2_B0(0,-3) + (rc8)*u2_B0(0,-4) - 4*u2_B0(0,-1))
)
:
      ((idx[1] == block0np1 - 2) ? (
   (rc11)*inv_0*(3*u2_B0(0,1) + 10*u2_B0(0,0) +
      6*u2_B0(0,-2) - u2_B0(0,-3) - 18*u2_B0(0,-1))
)
: (

      (rc11)*inv_0*(8*u2_B0(0,1) - u2_B0(0,2) + u2_B0(0,-2) -
      8*u2_B0(0,-1))
)))));
