...
void ops_par_loop_opensbliblock00Kernel065_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      const ACC<double> Residual0_B0(xdim0_opensbliblock00Kernel065, Residual0_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel065*1);
      const ACC<double> Residual1_B0(xdim1_opensbliblock00Kernel065, Residual1_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel065*1);
      const ACC<double> Residual2_B0(xdim2_opensbliblock00Kernel065, Residual2_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel065*1);
      const ACC<double> Residual3_B0(xdim3_opensbliblock00Kernel065, Residual3_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel065*1);
      ACC<double> rhoE_B0(xdim4_opensbliblock00Kernel065, rhoE_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel065*1);
      ACC<double> rhoE_RKold_B0(xdim5_opensbliblock00Kernel065, rhoE_RKold_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel065*1);
      ACC<double> rho_B0(xdim6_opensbliblock00Kernel065, rho_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel065*1);
      ACC<double> rho_RKold_B0(xdim7_opensbliblock00Kernel065, rho_RKold_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel065*1);
      ACC<double> rhou0_B0(xdim8_opensbliblock00Kernel065, rhou0_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel065*1);
      ACC<double> rhou0_RKold_B0(xdim9_opensbliblock00Kernel065, rhou0_RKold_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel065*1);
      ACC<double> rhou1_B0(xdim10_opensbliblock00Kernel065, rhou1_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel065*1);
      ACC<double> rhou1_RKold_B0(xdim11_opensbliblock00Kernel065, rhou1_RKold_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel065*1);
