...
#define OPENSBLIBLOCK00_KERNEL_H
 void opensbliblock00Kernel052(ACC<double> &rhoE_B0, ACC<double> &rho_B0, ACC<double> &rhou0_B0, ACC<double> &rhou1_B0,
...
: (
 ...
 void opensbliblock00Kernel055(const ACC<double> &x0_B0, const ACC<double> &x1_B0, ACC<double> &D00_B0, ACC<double>
...
void opensbliblock00Kernel032(const ACC<double> &u2_B0, ACC<double> &wk2_B0, const int *idx)
{
   if (idx[0] == 0){
...
void opensbliblock00Kernel034(const ACC<double> &T_B0, ACC<double> &wk3_B0, const int *idx)
{
   if (idx[0] == 0){
...
void opensbliblock00Kernel036(const ACC<double> &u0_B0, ACC<double> &wk4_B0, const int *idx)
{
   if (idx[1] == 0){
...
void opensbliblock00Kernel037(const ACC<double> &u1_B0, ACC<double> &wk5_B0, const int *idx)
{
   if (idx[1] == 0){
...
void opensbliblock00Kernel038(const ACC<double> &u2_B0, ACC<double> &wk6_B0, const int *idx)
{
   if (idx[1] == 0){
...
void opensbliblock00Kernel039(const ACC<double> &T_B0, ACC<double> &wk7_B0, const int *idx)
{
   if (idx[1] == 0){
 ...
 void opensbliblock00Kernel044(const ACC<double> &D00_B0, const ACC<double> &D01_B0, const ACC<double> &D10_B0, const
...
&Residual3_B0, const int *idx)
{
 ...
 void opensbliblock00Kernel065(const ACC<double> &Residual0_B0, const ACC<double> &Residual1_B0, const ACC<double>
