...
//
__constant__ int dims_opensbliblock00Kernel050 [4][1];
static int dims_opensbliblock00Kernel050_h [4][1] = {{0}};

//user function
__device__

void opensbliblock00Kernel050_gpu(ACC<double> &rhoE_B0,
  ACC<double> &rho_B0,
  ACC<double> &rhou0_B0,
  ACC<double> &rhou1_B0)
{
...
int size1 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel050[0][0];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel050[1][0];
  arg2 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel050[2][0];
  arg3 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel050[3][0];

  if (idx_x < size0 && idx_y < size1) {
    ACC<double> argp0(dims_opensbliblock00Kernel050[0][0], arg0);
    ACC<double> argp1(dims_opensbliblock00Kernel050[1][0], arg1);
    ACC<double> argp2(dims_opensbliblock00Kernel050[2][0], arg2);
    ACC<double> argp3(dims_opensbliblock00Kernel050[3][0], arg3);
    opensbliblock00Kernel050_gpu(argp0, argp1, argp2, argp3);
  }
...
void ops_par_loop_opensbliblock00Kernel050_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel050_h[0][0] || xdim1 != dims_opensbliblock00Kernel050_h[1][0] || xdim2 != dims_opensbliblock00Kernel050_h[2][0] || xdim3 != dims_opensbliblock00Kernel050_h[3][0]) {
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel050,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],
