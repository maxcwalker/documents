...
if (restart == 0){
int iteration_range_52_block0[] = {-5, block0np0 + 5, -5, block0np1 + 5};
ops_par_loop(opensbliblock00Kernel052, "Similiarity solution laminar boundary-layer initialisation0", opensbliblock00, 2, iteration_range_52_block0,
...
int iteration_range_55_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop(opensbliblock00Kernel055, "MetricsEquation evaluation", opensbliblock00, 2, iteration_range_55_block0,
...
int iteration_range_56_block0[] = {0, 1, -3, block0np1 + 4};
ops_par_loop(opensbliblock00Kernel056, "Metric_copy_block0 boundary dir0 side0", opensbliblock00, 2, iteration_range_56_block0,
...
int iteration_range_57_block0[] = {block0np0 - 1, block0np0, -3, block0np1 + 4};
ops_par_loop(opensbliblock00Kernel057, "Metric_copy_block0 boundary dir0 side1", opensbliblock00, 2, iteration_range_57_block0,
ops_arg_dat(D00_B0, 1, stencil_0_44_00_8, "double", OPS_RW),
ops_arg_dat(D01_B0, 1, stencil_0_44_00_8, "double", OPS_RW),
ops_arg_dat(D10_B0, 1, stencil_0_44_00_8, "double", OPS_RW),
ops_arg_dat(D11_B0, 1, stencil_0_44_00_8, "double", OPS_RW),
...
int iteration_range_58_block0[] = {-3, block0np0 + 4, 0, 1};
ops_par_loop(opensbliblock00Kernel058, "Metric_copy_block0 boundary dir1 side0", opensbliblock00, 2, iteration_range_58_block0,
...
int iteration_range_59_block0[] = {-3, block0np0 + 4, block0np1 - 1, block0np1};
ops_par_loop(opensbliblock00Kernel059, "Metric_copy_block0 boundary dir1 side1", opensbliblock00, 2, iteration_range_59_block0,
ops_arg_dat(D00_B0, 1, stencil_0_00_44_8, "double", OPS_RW),
ops_arg_dat(D01_B0, 1, stencil_0_00_44_8, "double", OPS_RW),
ops_arg_dat(D10_B0, 1, stencil_0_00_44_8, "double", OPS_RW),
ops_arg_dat(D11_B0, 1, stencil_0_00_44_8, "double", OPS_RW),
...
int iteration_range_48_block0[] = {0, 1, -3, block0np1 + 4};
ops_par_loop(opensbliblock00Kernel048, "InletTransfer boundary dir0 side0", opensbliblock00, 2, iteration_range_48_block0,
...
int iteration_range_49_block0[] = {block0np0 - 1, block0np0, -3, block0np1 + 4};
ops_par_loop(opensbliblock00Kernel049, "Extrapolation boundary dir0 side1", opensbliblock00, 2, iteration_range_49_block0,
...
int iteration_range_50_block0[] = {-3, block0np0 + 4, 0, 1};
ops_par_loop(opensbliblock00Kernel050, "IsothermalWall boundary dir1 side0", opensbliblock00, 2, iteration_range_50_block0,
...
int iteration_range_51_block0[] = {-3, block0np0 + 4, block0np1 - 1, block0np1};
ops_par_loop(opensbliblock00Kernel051, "ZeroGradientOutlet boundary dir1 side1", opensbliblock00, 2, iteration_range_51_block0,
...
ops_par_loop(opensbliblock00Kernel000, "LFTeno_reconstruction_0_direction", opensbliblock00, 2, iteration_range_0_block0,
...
ops_par_loop(opensbliblock00Kernel001, "LFTeno_reconstruction_1_direction", opensbliblock00, 2, iteration_range_1_block0,
...
ops_par_loop(opensbliblock00Kernel017, "LFTeno Residual", opensbliblock00, 2, iteration_range_17_block0,
...
ops_par_loop(opensbliblock00Kernel032, "Derivative evaluation CD u2_B0 xi0 ", opensbliblock00, 2, iteration_range_32_block0,
ops_arg_dat(u2_B0, 1, stencil_0_44_00_10, "double", OPS_READ),
ops_arg_dat(wk2_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_34_block0[] = {0, block0np0, -2, block0np1 + 2};
ops_par_loop(opensbliblock00Kernel034, "Derivative evaluation CD T_B0 xi0 ", opensbliblock00, 2, iteration_range_34_block0,
ops_arg_dat(T_B0, 1, stencil_0_44_00_10, "double", OPS_READ),
ops_arg_dat(wk3_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_36_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop(opensbliblock00Kernel036, "Derivative evaluation CD u0_B0 xi1 ", opensbliblock00, 2, iteration_range_36_block0,
ops_arg_dat(u0_B0, 1, stencil_0_00_24_8, "double", OPS_READ),
ops_arg_dat(wk4_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_37_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop(opensbliblock00Kernel037, "Derivative evaluation CD u1_B0 xi1 ", opensbliblock00, 2, iteration_range_37_block0,
ops_arg_dat(u1_B0, 1, stencil_0_00_24_8, "double", OPS_READ),
ops_arg_dat(wk5_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_38_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop(opensbliblock00Kernel038, "Derivative evaluation CD u2_B0 xi1 ", opensbliblock00, 2, iteration_range_38_block0,
ops_arg_dat(u2_B0, 1, stencil_0_00_24_8, "double", OPS_READ),
ops_arg_dat(wk6_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_39_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop(opensbliblock00Kernel039, "Derivative evaluation CD T_B0 xi1 ", opensbliblock00, 2, iteration_range_39_block0,
ops_arg_dat(T_B0, 1, stencil_0_00_24_8, "double", OPS_READ),
ops_arg_dat(wk7_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_44_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop(opensbliblock00Kernel044, "Viscous terms", opensbliblock00, 2, iteration_range_44_block0,
ops_arg_dat(D00_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
ops_arg_dat(D01_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
ops_arg_dat(D10_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
ops_arg_dat(D11_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
...
int iteration_range_65_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop(opensbliblock00Kernel065, "Temporal solution advancement", opensbliblock00, 2, iteration_range_65_block0,
