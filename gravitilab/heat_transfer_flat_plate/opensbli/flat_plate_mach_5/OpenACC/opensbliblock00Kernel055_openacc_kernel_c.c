...
void opensbliblock00Kernel055_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    ...
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      const ptr_double ptr0 = {  p_a0 + n_x*1*1 + n_y*xdim0_opensbliblock00Kernel055*1*1, xdim0_opensbliblock00Kernel055};
      const ptr_double ptr1 = {  p_a1 + n_x*1*1 + n_y*xdim1_opensbliblock00Kernel055*1*1, xdim1_opensbliblock00Kernel055};
      ...
      ptr_double ptr5 = {  p_a5 + n_x*1*1 + n_y*xdim5_opensbliblock00Kernel055*1*1, xdim5_opensbliblock00Kernel055};
      ptr_double ptr6 = {  p_a6 + n_x*1*1 + n_y*xdim6_opensbliblock00Kernel055*1*1, xdim6_opensbliblock00Kernel055};
      ptr_double ptr7 = {  p_a7 + n_x*1*1 + n_y*xdim7_opensbliblock00Kernel055*1*1, xdim7_opensbliblock00Kernel055};
      ptr_double ptr8 = {  p_a8 + n_x*1*1 + n_y*xdim8_opensbliblock00Kernel055*1*1, xdim8_opensbliblock00Kernel055};
      ptr_double ptr9 = {  p_a9 + n_x*1*1 + n_y*xdim9_opensbliblock00Kernel055*1*1, xdim9_opensbliblock00Kernel055};
      ptr_double ptr10 = {  p_a10 + n_x*1*1 + n_y*xdim10_opensbliblock00Kernel055*1*1, xdim10_opensbliblock00Kernel055};
