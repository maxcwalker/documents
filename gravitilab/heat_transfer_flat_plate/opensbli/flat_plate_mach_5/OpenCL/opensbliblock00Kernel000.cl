...
ptr_double a_B0,
  ...
  ptr_double wk1_B0,
  ptr_double wk2_B0,
  ptr_double wk3_B0, const double TENO_CT, const double eps, const double gama, const double gamma_m1, const double invgamma_m1, const double shock_filter_control)
{
   ...
   AVG_0_u0 = (sqrt(OPS_ACCS(rho_B0, 0,0))*OPS_ACCS(u0_B0, 0,0) + sqrt(OPS_ACCS(rho_B0, 1,0))*OPS_ACCS(u0_B0, 1,0))*AVG_0_inv_rho;

   AVG_0_u1 = (sqrt(OPS_ACCS(rho_B0, 0,0))*OPS_ACCS(u1_B0, 0,0) + sqrt(OPS_ACCS(rho_B0, 1,0))*OPS_ACCS(u1_B0, 1,0))*AVG_0_inv_rho;

    AVG_0_a = sqrt((-(1.0/2.0)*((AVG_0_u0*AVG_0_u0) + (AVG_0_u1*AVG_0_u1)) + ((OPS_ACCS(p_B0, 0,0) +
      OPS_ACCS(rhoE_B0, 0,0))/sqrt(OPS_ACCS(rho_B0, 0,0)) + (OPS_ACCS(p_B0, 1,0) + OPS_ACCS(rhoE_B0, 1,0))/sqrt(OPS_ACCS(rho_B0, 1,0)))*AVG_0_inv_rho)*gamma_m1);

   AVG_0_D01 = ((1.0/2.0))*(OPS_ACCS(D01_B0, 0,0) + OPS_ACCS(D01_B0, 1,0));

   AVG_0_D00 = ((1.0/2.0))*(OPS_ACCS(D00_B0, 0,0) + OPS_ACCS(D00_B0, 1,0));

   AVG_0_detJ = ((1.0/2.0))*(OPS_ACCS(detJ_B0, 0,0) + OPS_ACCS(detJ_B0, 1,0));
   ...
   AVG_0_0_LEV_33 = 0.707106781186547*gamma_m1*inv_AVG_a*inv_AVG_rho;
    ...
    CF_00 = (OPS_ACCS(p_B0, -2,0)*OPS_ACCS(U0_B0, -2,0)*AVG_0_0_LEV_03 + OPS_ACCS(p_B0, -2,0)*OPS_ACCS(D00_B0, -2,0)*AVG_0_0_LEV_01 +
      OPS_ACCS(p_B0, -2,0)*OPS_ACCS(D01_B0, -2,0)*AVG_0_0_LEV_02 + OPS_ACCS(U0_B0, -2,0)*OPS_ACCS(rho_B0, -2,0)*AVG_0_0_LEV_00 +
      OPS_ACCS(U0_B0, -2,0)*OPS_ACCS(rhoE_B0, -2,0)*AVG_0_0_LEV_03 + OPS_ACCS(U0_B0, -2,0)*OPS_ACCS(rhou0_B0, -2,0)*AVG_0_0_LEV_01 +
      OPS_ACCS(U0_B0, -2,0)*OPS_ACCS(rhou1_B0, -2,0)*AVG_0_0_LEV_02)*OPS_ACCS(detJ_B0, -2,0);

    CF_10 = (OPS_ACCS(p_B0, -2,0)*OPS_ACCS(D00_B0, -2,0)*AVG_0_0_LEV_11 + OPS_ACCS(p_B0, -2,0)*OPS_ACCS(D01_B0, -2,0)*AVG_0_0_LEV_12 +
      OPS_ACCS(U0_B0, -2,0)*OPS_ACCS(rho_B0, -2,0)*AVG_0_0_LEV_10 + OPS_ACCS(U0_B0, -2,0)*OPS_ACCS(rhou0_B0, -2,0)*AVG_0_0_LEV_11 +
      OPS_ACCS(U0_B0, -2,0)*OPS_ACCS(rhou1_B0, -2,0)*AVG_0_0_LEV_12)*OPS_ACCS(detJ_B0, -2,0);

    CF_20 = (OPS_ACCS(p_B0, -2,0)*OPS_ACCS(U0_B0, -2,0)*AVG_0_0_LEV_23 + OPS_ACCS(p_B0, -2,0)*OPS_ACCS(D00_B0, -2,0)*AVG_0_0_LEV_21 +
      OPS_ACCS(p_B0, -2,0)*OPS_ACCS(D01_B0, -2,0)*AVG_0_0_LEV_22 + OPS_ACCS(U0_B0, -2,0)*OPS_ACCS(rho_B0, -2,0)*AVG_0_0_LEV_20 +
      OPS_ACCS(U0_B0, -2,0)*OPS_ACCS(rhoE_B0, -2,0)*AVG_0_0_LEV_23 + OPS_ACCS(U0_B0, -2,0)*OPS_ACCS(rhou0_B0, -2,0)*AVG_0_0_LEV_21 +
      OPS_ACCS(U0_B0, -2,0)*OPS_ACCS(rhou1_B0, -2,0)*AVG_0_0_LEV_22)*OPS_ACCS(detJ_B0, -2,0);

    CF_30 = (OPS_ACCS(p_B0, -2,0)*OPS_ACCS(U0_B0, -2,0)*AVG_0_0_LEV_33 + OPS_ACCS(p_B0, -2,0)*OPS_ACCS(D00_B0, -2,0)*AVG_0_0_LEV_31 +
      OPS_ACCS(p_B0, -2,0)*OPS_ACCS(D01_B0, -2,0)*AVG_0_0_LEV_32 + OPS_ACCS(U0_B0, -2,0)*OPS_ACCS(rho_B0, -2,0)*AVG_0_0_LEV_30 +
      OPS_ACCS(U0_B0, -2,0)*OPS_ACCS(rhoE_B0, -2,0)*AVG_0_0_LEV_33 + OPS_ACCS(U0_B0, -2,0)*OPS_ACCS(rhou0_B0, -2,0)*AVG_0_0_LEV_31 +
      OPS_ACCS(U0_B0, -2,0)*OPS_ACCS(rhou1_B0, -2,0)*AVG_0_0_LEV_32)*OPS_ACCS(detJ_B0, -2,0);

    CS_00 = OPS_ACCS(rho_B0, -2,0)*AVG_0_0_LEV_00 + OPS_ACCS(rhoE_B0, -2,0)*AVG_0_0_LEV_03 + OPS_ACCS(rhou0_B0, -2,0)*AVG_0_0_LEV_01 +
      OPS_ACCS(rhou1_B0, -2,0)*AVG_0_0_LEV_02;

   CS_10 = OPS_ACCS(rho_B0, -2,0)*AVG_0_0_LEV_10 + OPS_ACCS(rhou0_B0, -2,0)*AVG_0_0_LEV_11 + OPS_ACCS(rhou1_B0, -2,0)*AVG_0_0_LEV_12;

    CS_20 = OPS_ACCS(rho_B0, -2,0)*AVG_0_0_LEV_20 + OPS_ACCS(rhoE_B0, -2,0)*AVG_0_0_LEV_23 + OPS_ACCS(rhou0_B0, -2,0)*AVG_0_0_LEV_21 +
      OPS_ACCS(rhou1_B0, -2,0)*AVG_0_0_LEV_22;

    CS_30 = OPS_ACCS(rho_B0, -2,0)*AVG_0_0_LEV_30 + OPS_ACCS(rhoE_B0, -2,0)*AVG_0_0_LEV_33 + OPS_ACCS(rhou0_B0, -2,0)*AVG_0_0_LEV_31 +
      OPS_ACCS(rhou1_B0, -2,0)*AVG_0_0_LEV_32;

    CF_01 = (OPS_ACCS(p_B0, -1,0)*OPS_ACCS(U0_B0, -1,0)*AVG_0_0_LEV_03 + OPS_ACCS(p_B0, -1,0)*OPS_ACCS(D00_B0, -1,0)*AVG_0_0_LEV_01 +
      OPS_ACCS(p_B0, -1,0)*OPS_ACCS(D01_B0, -1,0)*AVG_0_0_LEV_02 + OPS_ACCS(U0_B0, -1,0)*OPS_ACCS(rho_B0, -1,0)*AVG_0_0_LEV_00 +
      OPS_ACCS(U0_B0, -1,0)*OPS_ACCS(rhoE_B0, -1,0)*AVG_0_0_LEV_03 + OPS_ACCS(U0_B0, -1,0)*OPS_ACCS(rhou0_B0, -1,0)*AVG_0_0_LEV_01 +
      OPS_ACCS(U0_B0, -1,0)*OPS_ACCS(rhou1_B0, -1,0)*AVG_0_0_LEV_02)*OPS_ACCS(detJ_B0, -1,0);

    CF_11 = (OPS_ACCS(p_B0, -1,0)*OPS_ACCS(D00_B0, -1,0)*AVG_0_0_LEV_11 + OPS_ACCS(p_B0, -1,0)*OPS_ACCS(D01_B0, -1,0)*AVG_0_0_LEV_12 +
      OPS_ACCS(U0_B0, -1,0)*OPS_ACCS(rho_B0, -1,0)*AVG_0_0_LEV_10 + OPS_ACCS(U0_B0, -1,0)*OPS_ACCS(rhou0_B0, -1,0)*AVG_0_0_LEV_11 +
      OPS_ACCS(U0_B0, -1,0)*OPS_ACCS(rhou1_B0, -1,0)*AVG_0_0_LEV_12)*OPS_ACCS(detJ_B0, -1,0);

    CF_21 = (OPS_ACCS(p_B0, -1,0)*OPS_ACCS(U0_B0, -1,0)*AVG_0_0_LEV_23 + OPS_ACCS(p_B0, -1,0)*OPS_ACCS(D00_B0, -1,0)*AVG_0_0_LEV_21 +
      OPS_ACCS(p_B0, -1,0)*OPS_ACCS(D01_B0, -1,0)*AVG_0_0_LEV_22 + OPS_ACCS(U0_B0, -1,0)*OPS_ACCS(rho_B0, -1,0)*AVG_0_0_LEV_20 +
      OPS_ACCS(U0_B0, -1,0)*OPS_ACCS(rhoE_B0, -1,0)*AVG_0_0_LEV_23 + OPS_ACCS(U0_B0, -1,0)*OPS_ACCS(rhou0_B0, -1,0)*AVG_0_0_LEV_21 +
      OPS_ACCS(U0_B0, -1,0)*OPS_ACCS(rhou1_B0, -1,0)*AVG_0_0_LEV_22)*OPS_ACCS(detJ_B0, -1,0);

    CF_31 = (OPS_ACCS(p_B0, -1,0)*OPS_ACCS(U0_B0, -1,0)*AVG_0_0_LEV_33 + OPS_ACCS(p_B0, -1,0)*OPS_ACCS(D00_B0, -1,0)*AVG_0_0_LEV_31 +
      OPS_ACCS(p_B0, -1,0)*OPS_ACCS(D01_B0, -1,0)*AVG_0_0_LEV_32 + OPS_ACCS(U0_B0, -1,0)*OPS_ACCS(rho_B0, -1,0)*AVG_0_0_LEV_30 +
      OPS_ACCS(U0_B0, -1,0)*OPS_ACCS(rhoE_B0, -1,0)*AVG_0_0_LEV_33 + OPS_ACCS(U0_B0, -1,0)*OPS_ACCS(rhou0_B0, -1,0)*AVG_0_0_LEV_31 +
      OPS_ACCS(U0_B0, -1,0)*OPS_ACCS(rhou1_B0, -1,0)*AVG_0_0_LEV_32)*OPS_ACCS(detJ_B0, -1,0);

    CS_01 = OPS_ACCS(rho_B0, -1,0)*AVG_0_0_LEV_00 + OPS_ACCS(rhoE_B0, -1,0)*AVG_0_0_LEV_03 + OPS_ACCS(rhou0_B0, -1,0)*AVG_0_0_LEV_01 +
      OPS_ACCS(rhou1_B0, -1,0)*AVG_0_0_LEV_02;

   CS_11 = OPS_ACCS(rho_B0, -1,0)*AVG_0_0_LEV_10 + OPS_ACCS(rhou0_B0, -1,0)*AVG_0_0_LEV_11 + OPS_ACCS(rhou1_B0, -1,0)*AVG_0_0_LEV_12;

    CS_21 = OPS_ACCS(rho_B0, -1,0)*AVG_0_0_LEV_20 + OPS_ACCS(rhoE_B0, -1,0)*AVG_0_0_LEV_23 + OPS_ACCS(rhou0_B0, -1,0)*AVG_0_0_LEV_21 +
      OPS_ACCS(rhou1_B0, -1,0)*AVG_0_0_LEV_22;

    CS_31 = OPS_ACCS(rho_B0, -1,0)*AVG_0_0_LEV_30 + OPS_ACCS(rhoE_B0, -1,0)*AVG_0_0_LEV_33 + OPS_ACCS(rhou0_B0, -1,0)*AVG_0_0_LEV_31 +
      OPS_ACCS(rhou1_B0, -1,0)*AVG_0_0_LEV_32;

    CF_02 = (OPS_ACCS(p_B0, 0,0)*OPS_ACCS(U0_B0, 0,0)*AVG_0_0_LEV_03 + OPS_ACCS(p_B0, 0,0)*OPS_ACCS(D00_B0, 0,0)*AVG_0_0_LEV_01 +
      OPS_ACCS(p_B0, 0,0)*OPS_ACCS(D01_B0, 0,0)*AVG_0_0_LEV_02 + OPS_ACCS(U0_B0, 0,0)*OPS_ACCS(rho_B0, 0,0)*AVG_0_0_LEV_00 +
      OPS_ACCS(U0_B0, 0,0)*OPS_ACCS(rhoE_B0, 0,0)*AVG_0_0_LEV_03 + OPS_ACCS(U0_B0, 0,0)*OPS_ACCS(rhou0_B0, 0,0)*AVG_0_0_LEV_01 +
      OPS_ACCS(U0_B0, 0,0)*OPS_ACCS(rhou1_B0, 0,0)*AVG_0_0_LEV_02)*OPS_ACCS(detJ_B0, 0,0);

    CF_12 = (OPS_ACCS(p_B0, 0,0)*OPS_ACCS(D00_B0, 0,0)*AVG_0_0_LEV_11 + OPS_ACCS(p_B0, 0,0)*OPS_ACCS(D01_B0, 0,0)*AVG_0_0_LEV_12 +
      OPS_ACCS(U0_B0, 0,0)*OPS_ACCS(rho_B0, 0,0)*AVG_0_0_LEV_10 + OPS_ACCS(U0_B0, 0,0)*OPS_ACCS(rhou0_B0, 0,0)*AVG_0_0_LEV_11 +
      OPS_ACCS(U0_B0, 0,0)*OPS_ACCS(rhou1_B0, 0,0)*AVG_0_0_LEV_12)*OPS_ACCS(detJ_B0, 0,0);

    CF_22 = (OPS_ACCS(p_B0, 0,0)*OPS_ACCS(U0_B0, 0,0)*AVG_0_0_LEV_23 + OPS_ACCS(p_B0, 0,0)*OPS_ACCS(D00_B0, 0,0)*AVG_0_0_LEV_21 +
      OPS_ACCS(p_B0, 0,0)*OPS_ACCS(D01_B0, 0,0)*AVG_0_0_LEV_22 + OPS_ACCS(U0_B0, 0,0)*OPS_ACCS(rho_B0, 0,0)*AVG_0_0_LEV_20 +
      OPS_ACCS(U0_B0, 0,0)*OPS_ACCS(rhoE_B0, 0,0)*AVG_0_0_LEV_23 + OPS_ACCS(U0_B0, 0,0)*OPS_ACCS(rhou0_B0, 0,0)*AVG_0_0_LEV_21 +
      OPS_ACCS(U0_B0, 0,0)*OPS_ACCS(rhou1_B0, 0,0)*AVG_0_0_LEV_22)*OPS_ACCS(detJ_B0, 0,0);

    CF_32 = (OPS_ACCS(p_B0, 0,0)*OPS_ACCS(U0_B0, 0,0)*AVG_0_0_LEV_33 + OPS_ACCS(p_B0, 0,0)*OPS_ACCS(D00_B0, 0,0)*AVG_0_0_LEV_31 +
      OPS_ACCS(p_B0, 0,0)*OPS_ACCS(D01_B0, 0,0)*AVG_0_0_LEV_32 + OPS_ACCS(U0_B0, 0,0)*OPS_ACCS(rho_B0, 0,0)*AVG_0_0_LEV_30 +
      OPS_ACCS(U0_B0, 0,0)*OPS_ACCS(rhoE_B0, 0,0)*AVG_0_0_LEV_33 + OPS_ACCS(U0_B0, 0,0)*OPS_ACCS(rhou0_B0, 0,0)*AVG_0_0_LEV_31 +
      OPS_ACCS(U0_B0, 0,0)*OPS_ACCS(rhou1_B0, 0,0)*AVG_0_0_LEV_32)*OPS_ACCS(detJ_B0, 0,0);

    CS_02 = OPS_ACCS(rho_B0, 0,0)*AVG_0_0_LEV_00 + OPS_ACCS(rhoE_B0, 0,0)*AVG_0_0_LEV_03 + OPS_ACCS(rhou0_B0, 0,0)*AVG_0_0_LEV_01 +
      OPS_ACCS(rhou1_B0, 0,0)*AVG_0_0_LEV_02;

   CS_12 = OPS_ACCS(rho_B0, 0,0)*AVG_0_0_LEV_10 + OPS_ACCS(rhou0_B0, 0,0)*AVG_0_0_LEV_11 + OPS_ACCS(rhou1_B0, 0,0)*AVG_0_0_LEV_12;

    CS_22 = OPS_ACCS(rho_B0, 0,0)*AVG_0_0_LEV_20 + OPS_ACCS(rhoE_B0, 0,0)*AVG_0_0_LEV_23 + OPS_ACCS(rhou0_B0, 0,0)*AVG_0_0_LEV_21 +
      OPS_ACCS(rhou1_B0, 0,0)*AVG_0_0_LEV_22;

    CS_32 = OPS_ACCS(rho_B0, 0,0)*AVG_0_0_LEV_30 + OPS_ACCS(rhoE_B0, 0,0)*AVG_0_0_LEV_33 + OPS_ACCS(rhou0_B0, 0,0)*AVG_0_0_LEV_31 +
      OPS_ACCS(rhou1_B0, 0,0)*AVG_0_0_LEV_32;

    CF_03 = (OPS_ACCS(p_B0, 1,0)*OPS_ACCS(U0_B0, 1,0)*AVG_0_0_LEV_03 + OPS_ACCS(p_B0, 1,0)*OPS_ACCS(D00_B0, 1,0)*AVG_0_0_LEV_01 +
      OPS_ACCS(p_B0, 1,0)*OPS_ACCS(D01_B0, 1,0)*AVG_0_0_LEV_02 + OPS_ACCS(U0_B0, 1,0)*OPS_ACCS(rho_B0, 1,0)*AVG_0_0_LEV_00 +
      OPS_ACCS(U0_B0, 1,0)*OPS_ACCS(rhoE_B0, 1,0)*AVG_0_0_LEV_03 + OPS_ACCS(U0_B0, 1,0)*OPS_ACCS(rhou0_B0, 1,0)*AVG_0_0_LEV_01 +
      OPS_ACCS(U0_B0, 1,0)*OPS_ACCS(rhou1_B0, 1,0)*AVG_0_0_LEV_02)*OPS_ACCS(detJ_B0, 1,0);

    CF_13 = (OPS_ACCS(p_B0, 1,0)*OPS_ACCS(D00_B0, 1,0)*AVG_0_0_LEV_11 + OPS_ACCS(p_B0, 1,0)*OPS_ACCS(D01_B0, 1,0)*AVG_0_0_LEV_12 +
      OPS_ACCS(U0_B0, 1,0)*OPS_ACCS(rho_B0, 1,0)*AVG_0_0_LEV_10 + OPS_ACCS(U0_B0, 1,0)*OPS_ACCS(rhou0_B0, 1,0)*AVG_0_0_LEV_11 +
      OPS_ACCS(U0_B0, 1,0)*OPS_ACCS(rhou1_B0, 1,0)*AVG_0_0_LEV_12)*OPS_ACCS(detJ_B0, 1,0);

    CF_23 = (OPS_ACCS(p_B0, 1,0)*OPS_ACCS(U0_B0, 1,0)*AVG_0_0_LEV_23 + OPS_ACCS(p_B0, 1,0)*OPS_ACCS(D00_B0, 1,0)*AVG_0_0_LEV_21 +
      OPS_ACCS(p_B0, 1,0)*OPS_ACCS(D01_B0, 1,0)*AVG_0_0_LEV_22 + OPS_ACCS(U0_B0, 1,0)*OPS_ACCS(rho_B0, 1,0)*AVG_0_0_LEV_20 +
      OPS_ACCS(U0_B0, 1,0)*OPS_ACCS(rhoE_B0, 1,0)*AVG_0_0_LEV_23 + OPS_ACCS(U0_B0, 1,0)*OPS_ACCS(rhou0_B0, 1,0)*AVG_0_0_LEV_21 +
      OPS_ACCS(U0_B0, 1,0)*OPS_ACCS(rhou1_B0, 1,0)*AVG_0_0_LEV_22)*OPS_ACCS(detJ_B0, 1,0);

    CF_33 = (OPS_ACCS(p_B0, 1,0)*OPS_ACCS(U0_B0, 1,0)*AVG_0_0_LEV_33 + OPS_ACCS(p_B0, 1,0)*OPS_ACCS(D00_B0, 1,0)*AVG_0_0_LEV_31 +
      OPS_ACCS(p_B0, 1,0)*OPS_ACCS(D01_B0, 1,0)*AVG_0_0_LEV_32 + OPS_ACCS(U0_B0, 1,0)*OPS_ACCS(rho_B0, 1,0)*AVG_0_0_LEV_30 +
      OPS_ACCS(U0_B0, 1,0)*OPS_ACCS(rhoE_B0, 1,0)*AVG_0_0_LEV_33 + OPS_ACCS(U0_B0, 1,0)*OPS_ACCS(rhou0_B0, 1,0)*AVG_0_0_LEV_31 +
      OPS_ACCS(U0_B0, 1,0)*OPS_ACCS(rhou1_B0, 1,0)*AVG_0_0_LEV_32)*OPS_ACCS(detJ_B0, 1,0);

    CS_03 = OPS_ACCS(rho_B0, 1,0)*AVG_0_0_LEV_00 + OPS_ACCS(rhoE_B0, 1,0)*AVG_0_0_LEV_03 + OPS_ACCS(rhou0_B0, 1,0)*AVG_0_0_LEV_01 +
      OPS_ACCS(rhou1_B0, 1,0)*AVG_0_0_LEV_02;

   CS_13 = OPS_ACCS(rho_B0, 1,0)*AVG_0_0_LEV_10 + OPS_ACCS(rhou0_B0, 1,0)*AVG_0_0_LEV_11 + OPS_ACCS(rhou1_B0, 1,0)*AVG_0_0_LEV_12;

    CS_23 = OPS_ACCS(rho_B0, 1,0)*AVG_0_0_LEV_20 + OPS_ACCS(rhoE_B0, 1,0)*AVG_0_0_LEV_23 + OPS_ACCS(rhou0_B0, 1,0)*AVG_0_0_LEV_21 +
      OPS_ACCS(rhou1_B0, 1,0)*AVG_0_0_LEV_22;

    CS_33 = OPS_ACCS(rho_B0, 1,0)*AVG_0_0_LEV_30 + OPS_ACCS(rhoE_B0, 1,0)*AVG_0_0_LEV_33 + OPS_ACCS(rhou0_B0, 1,0)*AVG_0_0_LEV_31 +
      OPS_ACCS(rhou1_B0, 1,0)*AVG_0_0_LEV_32;

    CF_04 = (OPS_ACCS(p_B0, 2,0)*OPS_ACCS(U0_B0, 2,0)*AVG_0_0_LEV_03 + OPS_ACCS(p_B0, 2,0)*OPS_ACCS(D00_B0, 2,0)*AVG_0_0_LEV_01 +
      OPS_ACCS(p_B0, 2,0)*OPS_ACCS(D01_B0, 2,0)*AVG_0_0_LEV_02 + OPS_ACCS(U0_B0, 2,0)*OPS_ACCS(rho_B0, 2,0)*AVG_0_0_LEV_00 +
      OPS_ACCS(U0_B0, 2,0)*OPS_ACCS(rhoE_B0, 2,0)*AVG_0_0_LEV_03 + OPS_ACCS(U0_B0, 2,0)*OPS_ACCS(rhou0_B0, 2,0)*AVG_0_0_LEV_01 +
      OPS_ACCS(U0_B0, 2,0)*OPS_ACCS(rhou1_B0, 2,0)*AVG_0_0_LEV_02)*OPS_ACCS(detJ_B0, 2,0);

    CF_14 = (OPS_ACCS(p_B0, 2,0)*OPS_ACCS(D00_B0, 2,0)*AVG_0_0_LEV_11 + OPS_ACCS(p_B0, 2,0)*OPS_ACCS(D01_B0, 2,0)*AVG_0_0_LEV_12 +
      OPS_ACCS(U0_B0, 2,0)*OPS_ACCS(rho_B0, 2,0)*AVG_0_0_LEV_10 + OPS_ACCS(U0_B0, 2,0)*OPS_ACCS(rhou0_B0, 2,0)*AVG_0_0_LEV_11 +
      OPS_ACCS(U0_B0, 2,0)*OPS_ACCS(rhou1_B0, 2,0)*AVG_0_0_LEV_12)*OPS_ACCS(detJ_B0, 2,0);

    CF_24 = (OPS_ACCS(p_B0, 2,0)*OPS_ACCS(U0_B0, 2,0)*AVG_0_0_LEV_23 + OPS_ACCS(p_B0, 2,0)*OPS_ACCS(D00_B0, 2,0)*AVG_0_0_LEV_21 +
      OPS_ACCS(p_B0, 2,0)*OPS_ACCS(D01_B0, 2,0)*AVG_0_0_LEV_22 + OPS_ACCS(U0_B0, 2,0)*OPS_ACCS(rho_B0, 2,0)*AVG_0_0_LEV_20 +
      OPS_ACCS(U0_B0, 2,0)*OPS_ACCS(rhoE_B0, 2,0)*AVG_0_0_LEV_23 + OPS_ACCS(U0_B0, 2,0)*OPS_ACCS(rhou0_B0, 2,0)*AVG_0_0_LEV_21 +
      OPS_ACCS(U0_B0, 2,0)*OPS_ACCS(rhou1_B0, 2,0)*AVG_0_0_LEV_22)*OPS_ACCS(detJ_B0, 2,0);

    CF_34 = (OPS_ACCS(p_B0, 2,0)*OPS_ACCS(U0_B0, 2,0)*AVG_0_0_LEV_33 + OPS_ACCS(p_B0, 2,0)*OPS_ACCS(D00_B0, 2,0)*AVG_0_0_LEV_31 +
      OPS_ACCS(p_B0, 2,0)*OPS_ACCS(D01_B0, 2,0)*AVG_0_0_LEV_32 + OPS_ACCS(U0_B0, 2,0)*OPS_ACCS(rho_B0, 2,0)*AVG_0_0_LEV_30 +
      OPS_ACCS(U0_B0, 2,0)*OPS_ACCS(rhoE_B0, 2,0)*AVG_0_0_LEV_33 + OPS_ACCS(U0_B0, 2,0)*OPS_ACCS(rhou0_B0, 2,0)*AVG_0_0_LEV_31 +
      OPS_ACCS(U0_B0, 2,0)*OPS_ACCS(rhou1_B0, 2,0)*AVG_0_0_LEV_32)*OPS_ACCS(detJ_B0, 2,0);

    CS_04 = OPS_ACCS(rho_B0, 2,0)*AVG_0_0_LEV_00 + OPS_ACCS(rhoE_B0, 2,0)*AVG_0_0_LEV_03 + OPS_ACCS(rhou0_B0, 2,0)*AVG_0_0_LEV_01 +
      OPS_ACCS(rhou1_B0, 2,0)*AVG_0_0_LEV_02;

   CS_14 = OPS_ACCS(rho_B0, 2,0)*AVG_0_0_LEV_10 + OPS_ACCS(rhou0_B0, 2,0)*AVG_0_0_LEV_11 + OPS_ACCS(rhou1_B0, 2,0)*AVG_0_0_LEV_12;

    CS_24 = OPS_ACCS(rho_B0, 2,0)*AVG_0_0_LEV_20 + OPS_ACCS(rhoE_B0, 2,0)*AVG_0_0_LEV_23 + OPS_ACCS(rhou0_B0, 2,0)*AVG_0_0_LEV_21 +
      OPS_ACCS(rhou1_B0, 2,0)*AVG_0_0_LEV_22;

    CS_34 = OPS_ACCS(rho_B0, 2,0)*AVG_0_0_LEV_30 + OPS_ACCS(rhoE_B0, 2,0)*AVG_0_0_LEV_33 + OPS_ACCS(rhou0_B0, 2,0)*AVG_0_0_LEV_31 +
      OPS_ACCS(rhou1_B0, 2,0)*AVG_0_0_LEV_32;

    CF_05 = (OPS_ACCS(p_B0, 3,0)*OPS_ACCS(U0_B0, 3,0)*AVG_0_0_LEV_03 + OPS_ACCS(p_B0, 3,0)*OPS_ACCS(D00_B0, 3,0)*AVG_0_0_LEV_01 +
      OPS_ACCS(p_B0, 3,0)*OPS_ACCS(D01_B0, 3,0)*AVG_0_0_LEV_02 + OPS_ACCS(U0_B0, 3,0)*OPS_ACCS(rho_B0, 3,0)*AVG_0_0_LEV_00 +
      OPS_ACCS(U0_B0, 3,0)*OPS_ACCS(rhoE_B0, 3,0)*AVG_0_0_LEV_03 + OPS_ACCS(U0_B0, 3,0)*OPS_ACCS(rhou0_B0, 3,0)*AVG_0_0_LEV_01 +
      OPS_ACCS(U0_B0, 3,0)*OPS_ACCS(rhou1_B0, 3,0)*AVG_0_0_LEV_02)*OPS_ACCS(detJ_B0, 3,0);

    CF_15 = (OPS_ACCS(p_B0, 3,0)*OPS_ACCS(D00_B0, 3,0)*AVG_0_0_LEV_11 + OPS_ACCS(p_B0, 3,0)*OPS_ACCS(D01_B0, 3,0)*AVG_0_0_LEV_12 +
      OPS_ACCS(U0_B0, 3,0)*OPS_ACCS(rho_B0, 3,0)*AVG_0_0_LEV_10 + OPS_ACCS(U0_B0, 3,0)*OPS_ACCS(rhou0_B0, 3,0)*AVG_0_0_LEV_11 +
      OPS_ACCS(U0_B0, 3,0)*OPS_ACCS(rhou1_B0, 3,0)*AVG_0_0_LEV_12)*OPS_ACCS(detJ_B0, 3,0);

    CF_25 = (OPS_ACCS(p_B0, 3,0)*OPS_ACCS(U0_B0, 3,0)*AVG_0_0_LEV_23 + OPS_ACCS(p_B0, 3,0)*OPS_ACCS(D00_B0, 3,0)*AVG_0_0_LEV_21 +
      OPS_ACCS(p_B0, 3,0)*OPS_ACCS(D01_B0, 3,0)*AVG_0_0_LEV_22 + OPS_ACCS(U0_B0, 3,0)*OPS_ACCS(rho_B0, 3,0)*AVG_0_0_LEV_20 +
      OPS_ACCS(U0_B0, 3,0)*OPS_ACCS(rhoE_B0, 3,0)*AVG_0_0_LEV_23 + OPS_ACCS(U0_B0, 3,0)*OPS_ACCS(rhou0_B0, 3,0)*AVG_0_0_LEV_21 +
      OPS_ACCS(U0_B0, 3,0)*OPS_ACCS(rhou1_B0, 3,0)*AVG_0_0_LEV_22)*OPS_ACCS(detJ_B0, 3,0);

    CF_35 = (OPS_ACCS(p_B0, 3,0)*OPS_ACCS(U0_B0, 3,0)*AVG_0_0_LEV_33 + OPS_ACCS(p_B0, 3,0)*OPS_ACCS(D00_B0, 3,0)*AVG_0_0_LEV_31 +
      OPS_ACCS(p_B0, 3,0)*OPS_ACCS(D01_B0, 3,0)*AVG_0_0_LEV_32 + OPS_ACCS(U0_B0, 3,0)*OPS_ACCS(rho_B0, 3,0)*AVG_0_0_LEV_30 +
      OPS_ACCS(U0_B0, 3,0)*OPS_ACCS(rhoE_B0, 3,0)*AVG_0_0_LEV_33 + OPS_ACCS(U0_B0, 3,0)*OPS_ACCS(rhou0_B0, 3,0)*AVG_0_0_LEV_31 +
      OPS_ACCS(U0_B0, 3,0)*OPS_ACCS(rhou1_B0, 3,0)*AVG_0_0_LEV_32)*OPS_ACCS(detJ_B0, 3,0);

    CS_05 = OPS_ACCS(rho_B0, 3,0)*AVG_0_0_LEV_00 + OPS_ACCS(rhoE_B0, 3,0)*AVG_0_0_LEV_03 + OPS_ACCS(rhou0_B0, 3,0)*AVG_0_0_LEV_01 +
      OPS_ACCS(rhou1_B0, 3,0)*AVG_0_0_LEV_02;

   CS_15 = OPS_ACCS(rho_B0, 3,0)*AVG_0_0_LEV_10 + OPS_ACCS(rhou0_B0, 3,0)*AVG_0_0_LEV_11 + OPS_ACCS(rhou1_B0, 3,0)*AVG_0_0_LEV_12;

    CS_25 = OPS_ACCS(rho_B0, 3,0)*AVG_0_0_LEV_20 + OPS_ACCS(rhoE_B0, 3,0)*AVG_0_0_LEV_23 + OPS_ACCS(rhou0_B0, 3,0)*AVG_0_0_LEV_21 +
      OPS_ACCS(rhou1_B0, 3,0)*AVG_0_0_LEV_22;

    CS_35 = OPS_ACCS(rho_B0, 3,0)*AVG_0_0_LEV_30 + OPS_ACCS(rhoE_B0, 3,0)*AVG_0_0_LEV_33 + OPS_ACCS(rhou0_B0, 3,0)*AVG_0_0_LEV_31 +
      OPS_ACCS(rhou1_B0, 3,0)*AVG_0_0_LEV_32;

    max_lambda_00 = shock_filter_control*fmax(fabs(OPS_ACCS(u0_B0, 0,0)*OPS_ACCS(D00_B0, 0,0)*OPS_ACCS(detJ_B0, 0,0) +
      OPS_ACCS(u1_B0, 0,0)*OPS_ACCS(D01_B0, 0,0)*OPS_ACCS(detJ_B0, 0,0)), fabs(OPS_ACCS(u0_B0, 1,0)*OPS_ACCS(D00_B0, 1,0)*OPS_ACCS(detJ_B0, 1,0) +
      OPS_ACCS(u1_B0, 1,0)*OPS_ACCS(D01_B0, 1,0)*OPS_ACCS(detJ_B0, 1,0)));

   max_lambda_11 = max_lambda_00;

    max_lambda_22 = shock_filter_control*fmax(fabs(sqrt((OPS_ACCS(D00_B0, 1,0)*OPS_ACCS(D00_B0, 1,0))*(OPS_ACCS(detJ_B0, 1,0)*OPS_ACCS(detJ_B0, 1,0)) +
      (OPS_ACCS(D01_B0, 1,0)*OPS_ACCS(D01_B0, 1,0))*(OPS_ACCS(detJ_B0, 1,0)*OPS_ACCS(detJ_B0, 1,0)))*OPS_ACCS(a_B0, 1,0) + OPS_ACCS(u0_B0, 1,0)*OPS_ACCS(D00_B0, 1,0)*OPS_ACCS(detJ_B0, 1,0) +
      OPS_ACCS(u1_B0, 1,0)*OPS_ACCS(D01_B0, 1,0)*OPS_ACCS(detJ_B0, 1,0)), fabs(sqrt((OPS_ACCS(D00_B0, 0,0)*OPS_ACCS(D00_B0, 0,0))*(OPS_ACCS(detJ_B0, 0,0)*OPS_ACCS(detJ_B0, 0,0)) +
      (OPS_ACCS(D01_B0, 0,0)*OPS_ACCS(D01_B0, 0,0))*(OPS_ACCS(detJ_B0, 0,0)*OPS_ACCS(detJ_B0, 0,0)))*OPS_ACCS(a_B0, 0,0) + OPS_ACCS(u0_B0, 0,0)*OPS_ACCS(D00_B0, 0,0)*OPS_ACCS(detJ_B0, 0,0) +
      OPS_ACCS(u1_B0, 0,0)*OPS_ACCS(D01_B0, 0,0)*OPS_ACCS(detJ_B0, 0,0)));

    max_lambda_33 = shock_filter_control*fmax(fabs(-sqrt((OPS_ACCS(D00_B0, 1,0)*OPS_ACCS(D00_B0, 1,0))*(OPS_ACCS(detJ_B0, 1,0)*OPS_ACCS(detJ_B0, 1,0)) +
      (OPS_ACCS(D01_B0, 1,0)*OPS_ACCS(D01_B0, 1,0))*(OPS_ACCS(detJ_B0, 1,0)*OPS_ACCS(detJ_B0, 1,0)))*OPS_ACCS(a_B0, 1,0) + OPS_ACCS(u0_B0, 1,0)*OPS_ACCS(D00_B0, 1,0)*OPS_ACCS(detJ_B0, 1,0) +
      OPS_ACCS(u1_B0, 1,0)*OPS_ACCS(D01_B0, 1,0)*OPS_ACCS(detJ_B0, 1,0)), fabs(-sqrt((OPS_ACCS(D00_B0, 0,0)*OPS_ACCS(D00_B0, 0,0))*(OPS_ACCS(detJ_B0, 0,0)*OPS_ACCS(detJ_B0, 0,0)) +
      (OPS_ACCS(D01_B0, 0,0)*OPS_ACCS(D01_B0, 0,0))*(OPS_ACCS(detJ_B0, 0,0)*OPS_ACCS(detJ_B0, 0,0)))*OPS_ACCS(a_B0, 0,0) + OPS_ACCS(u0_B0, 0,0)*OPS_ACCS(D00_B0, 0,0)*OPS_ACCS(detJ_B0, 0,0) +
      OPS_ACCS(u1_B0, 0,0)*OPS_ACCS(D01_B0, 0,0)*OPS_ACCS(detJ_B0, 0,0)));
...
: (
   1.0
    ...
    OPS_ACCS(wk0_B0, 0,0) = 0.707106781186547*AVG_0_rho*Recon_2*inv_AVG_a + 0.707106781186547*AVG_0_rho*Recon_3*inv_AVG_a +
      Recon_0;

    OPS_ACCS(wk1_B0, 0,0) = AVG_0_u0*Recon_0 + AVG_0_D01*AVG_0_rho*Recon_1*inv_AVG_met_fact +
    ...
    OPS_ACCS(wk2_B0, 0,0) = AVG_0_u1*Recon_0 - AVG_0_D00*AVG_0_rho*Recon_1*inv_AVG_met_fact +
    ...
    OPS_ACCS(wk3_B0, 0,0) = (((1.0/2.0))*(AVG_0_u0*AVG_0_u0) + ((1.0/2.0))*(AVG_0_u1*AVG_0_u1))*Recon_0 +
