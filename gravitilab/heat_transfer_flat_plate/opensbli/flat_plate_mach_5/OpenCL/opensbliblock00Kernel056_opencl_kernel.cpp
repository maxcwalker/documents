...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel056(OPS_instance *instance, int xdim0, int xdim1, int xdim2, int xdim3, int xdim4) {
      ...
      if(!isbuilt_opensbliblock00Kernel056) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[2] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel056", &ret);
        clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel056(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,2,"opensbliblock00Kernel056");
