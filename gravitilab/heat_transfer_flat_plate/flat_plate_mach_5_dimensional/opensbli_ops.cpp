...
invgama = 1.0/(gama);ops_decl_const2( "Delta0block0",1, "double",&Delta0block0);ops_decl_const2( "Delta1block0",1, "double",&Delta1block0);ops_decl_const2( "HDF5_timing",1, "int",&HDF5_timing);ops_decl_const2( "Minf",1, "double",&Minf);ops_decl_const2( "Pr",1, "double",&Pr);ops_decl_const2( "Re",1, "double",&Re);ops_decl_const2( "RefT",1, "double",&RefT);ops_decl_const2( "Rhat",1, "double",&Rhat);ops_decl_const2( "SuthT",1, "double",&SuthT);ops_decl_const2( "Twall",1, "double",&Twall);ops_decl_const2( "block0np0",1, "int",&block0np0);ops_decl_const2( "block0np1",1, "int",&block0np1);ops_decl_const2( "dt",1, "double",&dt);ops_decl_const2( "gama",1, "double",&gama);ops_decl_const2( "inv2Delta0block0",1, "double",&inv2Delta0block0);ops_decl_const2( "inv2Delta1block0",1, "double",&inv2Delta1block0);ops_decl_const2( "inv2Minf",1, "double",&inv2Minf);ops_decl_const2( "invDelta0block0",1, "double",&invDelta0block0);ops_decl_const2( "invDelta1block0",1, "double",&invDelta1block0);ops_decl_const2( "invPr",1, "double",&invPr);ops_decl_const2( "invRe",1, "double",&invRe);ops_decl_const2( "invRefT",1, "double",&invRefT);ops_decl_const2( "invRhat",1, "double",&invRhat);ops_decl_const2( "inv_gamma_m1",1, "double",&inv_gamma_m1);ops_decl_const2( "invgama",1, "double",&invgama);ops_decl_const2( "niter",1, "int",&niter);ops_decl_const2( "pref",1, "double",&pref);ops_decl_const2( "simulation_time",1, "double",&simulation_time);ops_decl_const2( "start_iter",1, "int",&start_iter);ops_decl_const2( "write_output_file",1, "int",&write_output_file);
...
if (restart == 0){
int iteration_range_26_block0[] = {-2, block0np0 + 2, -2, block0np1 + 2}; ops_par_loop_opensbliblock00Kernel026("Grid_based_initialisation0", opensbliblock00, 2, iteration_range_26_block0,
...
int iteration_range_29_block0[] = {0, block0np0, 0, block0np1}; ops_par_loop_opensbliblock00Kernel029("MetricsEquation evaluation", opensbliblock00, 2, iteration_range_29_block0,
...
int iteration_range_30_block0[] = {0, 1, -2, block0np1 + 2}; ops_par_loop_opensbliblock00Kernel030("Metric_copy_block0 boundary dir0 side0", opensbliblock00, 2, iteration_range_30_block0,
...
int iteration_range_31_block0[] = {block0np0 - 1, block0np0, -2, block0np1 + 2}; ops_par_loop_opensbliblock00Kernel031("Metric_copy_block0 boundary dir0 side1", opensbliblock00, 2, iteration_range_31_block0,
             ops_arg_dat(D00_B0, 1, stencil_0_22_00_4, "double", OPS_RW),
             ops_arg_dat(D01_B0, 1, stencil_0_22_00_4, "double", OPS_RW),
             ops_arg_dat(D10_B0, 1, stencil_0_22_00_4, "double", OPS_RW),
             ops_arg_dat(D11_B0, 1, stencil_0_22_00_4, "double", OPS_RW),
...
int iteration_range_32_block0[] = {-2, block0np0 + 2, 0, 1}; ops_par_loop_opensbliblock00Kernel032("Metric_copy_block0 boundary dir1 side0", opensbliblock00, 2, iteration_range_32_block0,
...
int iteration_range_33_block0[] = {-2, block0np0 + 2, block0np1 - 1, block0np1}; ops_par_loop_opensbliblock00Kernel033("Metric_copy_block0 boundary dir1 side1", opensbliblock00, 2, iteration_range_33_block0,
             ops_arg_dat(D00_B0, 1, stencil_0_00_22_4, "double", OPS_RW),
             ops_arg_dat(D01_B0, 1, stencil_0_00_22_4, "double", OPS_RW),
             ops_arg_dat(D10_B0, 1, stencil_0_00_22_4, "double", OPS_RW),
             ops_arg_dat(D11_B0, 1, stencil_0_00_22_4, "double", OPS_RW),
...
int iteration_range_38_block0[] = {0, block0np0, 0, block0np1}; ops_par_loop_opensbliblock00Kernel038("MetricsEquation evaluation", opensbliblock00, 2, iteration_range_38_block0,
...
int iteration_range_22_block0[] = {0, 1, -2, block0np1 + 2}; ops_par_loop_opensbliblock00Kernel022("InletPressureExtrapolate boundary dir0 side0", opensbliblock00, 2, iteration_range_22_block0,
...
int iteration_range_23_block0[] = {block0np0 - 1, block0np0, -2, block0np1 + 2}; ops_par_loop_opensbliblock00Kernel023("Extrapolation boundary dir0 side1", opensbliblock00, 2, iteration_range_23_block0,
...
int iteration_range_24_block0[] = {-2, block0np0 + 2, 0, 1}; ops_par_loop_opensbliblock00Kernel024("IsothermalWall boundary dir1 side0", opensbliblock00, 2, iteration_range_24_block0,
...
int iteration_range_25_block0[] = {-2, block0np0 + 2, block0np1 - 1, block0np1 + 2}; ops_par_loop_opensbliblock00Kernel025("Dirichlet boundary dir1 side1", opensbliblock00, 2, iteration_range_25_block0,
             ops_arg_dat(rhoE_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
...
{
int iteration_range_1_block0[] = {-2, block0np0 + 2, -2, block0np1 + 2}; ops_par_loop_opensbliblock00Kernel001("CRu0_B0", opensbliblock00, 2, iteration_range_1_block0,
...
int iteration_range_3_block0[] = {-2, block0np0 + 2, -2, block0np1 + 2}; ops_par_loop_opensbliblock00Kernel003("CRu1_B0", opensbliblock00, 2, iteration_range_3_block0,
             ops_arg_dat(rho_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
             ops_arg_dat(rhou1_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
             ops_arg_dat(u1_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE));

int iteration_range_12_block0[] = {-2, block0np0 + 2, -2, block0np1 + 2}; ops_par_loop_opensbliblock00Kernel012("CRp_B0", opensbliblock00, 2, iteration_range_12_block0,
...
int iteration_range_7_block0[] = {-2, block0np0 + 2, -2, block0np1 + 2}; ops_par_loop_opensbliblock00Kernel007("CRT_B0", opensbliblock00, 2, iteration_range_7_block0,
...
int iteration_range_0_block0[] = {0, block0np0, -2, block0np1 + 2}; ops_par_loop_opensbliblock00Kernel000("Derivative evaluation CD u0_B0 xi0 ", opensbliblock00, 2, iteration_range_0_block0,
             ops_arg_dat(u0_B0, 1, stencil_0_44_00_10, "double", OPS_READ),
             ops_arg_dat(wk0_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_2_block0[] = {0, block0np0, -2, block0np1 + 2}; ops_par_loop_opensbliblock00Kernel002("Derivative evaluation CD u1_B0 xi0 ", opensbliblock00, 2, iteration_range_2_block0,
             ops_arg_dat(u1_B0, 1, stencil_0_44_00_10, "double", OPS_READ),
             ops_arg_dat(wk1_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_4_block0[] = {0, block0np0, 0, block0np1}; ops_par_loop_opensbliblock00Kernel004("Derivative evaluation CD u2_B0 xi0 ", opensbliblock00, 2, iteration_range_4_block0,
             ops_arg_dat(u2_B0, 1, stencil_0_44_00_10, "double", OPS_READ),
             ops_arg_dat(wk2_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_6_block0[] = {0, block0np0, -2, block0np1 + 2}; ops_par_loop_opensbliblock00Kernel006("Derivative evaluation CD T_B0 xi0 ", opensbliblock00, 2, iteration_range_6_block0,
             ops_arg_dat(T_B0, 1, stencil_0_44_00_10, "double", OPS_READ),
             ops_arg_dat(wk3_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_8_block0[] = {0, block0np0, 0, block0np1}; ops_par_loop_opensbliblock00Kernel008("Derivative evaluation CD u0_B0 xi1 ", opensbliblock00, 2, iteration_range_8_block0,
             ops_arg_dat(u0_B0, 1, stencil_0_00_44_10, "double", OPS_READ),
             ops_arg_dat(wk4_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_9_block0[] = {0, block0np0, 0, block0np1}; ops_par_loop_opensbliblock00Kernel009("Derivative evaluation CD u1_B0 xi1 ", opensbliblock00, 2, iteration_range_9_block0,
             ops_arg_dat(u1_B0, 1, stencil_0_00_44_10, "double", OPS_READ),
             ops_arg_dat(wk5_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_10_block0[] = {0, block0np0, 0, block0np1}; ops_par_loop_opensbliblock00Kernel010("Derivative evaluation CD u2_B0 xi1 ", opensbliblock00, 2, iteration_range_10_block0,
