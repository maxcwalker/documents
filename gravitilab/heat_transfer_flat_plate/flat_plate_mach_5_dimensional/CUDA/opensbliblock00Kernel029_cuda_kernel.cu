...
//
__constant__ int dims_opensbliblock00Kernel029 [12][1];
static int dims_opensbliblock00Kernel029_h [12][1] = {0};

//user function
__device__

 void opensbliblock00Kernel029_gpu(const ACC<double> &x0_B0,
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp4(dims_opensbliblock00Kernel029[4][0], arg4);
    ACC<double> argp5(dims_opensbliblock00Kernel029[5][0], arg5);
    ACC<double> argp6(dims_opensbliblock00Kernel029[6][0], arg6);
    ACC<double> argp7(dims_opensbliblock00Kernel029[7][0], arg7);
    ACC<double> argp8(dims_opensbliblock00Kernel029[8][0], arg8);
    ACC<double> argp9(dims_opensbliblock00Kernel029[9][0], arg9);
    ACC<double> argp10(dims_opensbliblock00Kernel029[10][0], arg10);
