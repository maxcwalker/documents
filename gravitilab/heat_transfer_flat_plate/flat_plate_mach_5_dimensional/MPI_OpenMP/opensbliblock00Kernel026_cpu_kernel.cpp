...
void ops_par_loop_opensbliblock00Kernel026_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      const ACC<double> x1_B0(xdim0_opensbliblock00Kernel026, x1_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel026*1);
      ACC<double> rhoE_B0(xdim1_opensbliblock00Kernel026, rhoE_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel026*1);
