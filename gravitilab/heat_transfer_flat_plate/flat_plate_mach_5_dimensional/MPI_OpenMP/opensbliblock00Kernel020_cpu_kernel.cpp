...
void ops_par_loop_opensbliblock00Kernel020_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> D00_B0(xdim0_opensbliblock00Kernel020, D00_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel020*1);
      const ACC<double> D01_B0(xdim1_opensbliblock00Kernel020, D01_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel020*1);
      const ACC<double> D10_B0(xdim2_opensbliblock00Kernel020, D10_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel020*1);
      const ACC<double> D11_B0(xdim3_opensbliblock00Kernel020, D11_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel020*1);
      const ACC<double> p_B0(xdim4_opensbliblock00Kernel020, p_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel020*1);
      const ACC<double> rhoE_B0(xdim5_opensbliblock00Kernel020, rhoE_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel020*1);
      const ACC<double> rhou0_B0(xdim6_opensbliblock00Kernel020, rhou0_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel020*1);
      const ACC<double> rhou1_B0(xdim7_opensbliblock00Kernel020, rhou1_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel020*1);
      const ACC<double> u0_B0(xdim8_opensbliblock00Kernel020, u0_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel020*1);
      const ACC<double> u1_B0(xdim9_opensbliblock00Kernel020, u1_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel020*1);
      ACC<double> Residual0_B0(xdim10_opensbliblock00Kernel020, Residual0_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel020*1);
      ACC<double> Residual1_B0(xdim11_opensbliblock00Kernel020, Residual1_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel020*1);
      ACC<double> Residual2_B0(xdim12_opensbliblock00Kernel020, Residual2_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel020*1);
      ACC<double> Residual3_B0(xdim13_opensbliblock00Kernel020, Residual3_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel020*1);
