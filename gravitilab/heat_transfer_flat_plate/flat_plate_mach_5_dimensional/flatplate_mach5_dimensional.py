...
from opensbli.utilities.init_dimflat2 import Initialise_DimFlat
...
heat_flux = "Eq(q_j, -0.26/Re*Der(T,x_j))"
# heat_flux = "Eq(q_j, (-mu/((gama-1)*Minf*Minf*Pr*Re))*Der(T,x_j))"

# Substitutions
substitutions = [stress_tensor, heat_flux]
constants_var = ["Re", "Pr", "gama", "Minf", "SuthT", "RefT", "Refmu", "R"]
...
Re, xMach, Tinf = 1.0, 5.0, 288.0
rhoref, uref, ydomain, blthickness = 0.12047, 576.5902, 0.00027387*110, 0.00027387
...
initial = Initialise_DimFlat(polynomial_directions, n_poly_coefficients,  Re, xMach, Tinf, rhoref, uref, ydomain, blthickness)
