...
ptr_double SD111_B0,
  ...
  const int *idx, const int block0np0, const int block0np1, const double inv2Delta0block0, const double inv2Delta1block0, const double inv2Minf, const double invDelta0block0, const double invDelta1block0, const double invPr, const double invRe, const double inv_gamma_m1)
{
   double d1_mu_dx = 0.0;
   double d1_mu_dy = 0.0;
