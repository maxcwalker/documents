...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel030(OPS_instance *instance, int xdim0, int xdim1, int xdim2, int xdim3, int xdim4) {
      ...
      if(!isbuilt_opensbliblock00Kernel030) {
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel030 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel030=%d  -Dxdim1_opensbliblock00Kernel030=%d  -Dxdim2_opensbliblock00Kernel030=%d  -Dxdim3_opensbliblock00Kernel030=%d  -Dxdim4_opensbliblock00Kernel030=%d ", pPath, 32,xdim0,xdim1,xdim2,xdim3,xdim4);
            else
              sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel030=%d  -Dxdim1_opensbliblock00Kernel030=%d  -Dxdim2_opensbliblock00Kernel030=%d  -Dxdim3_opensbliblock00Kernel030=%d  -Dxdim4_opensbliblock00Kernel030=%d ", pPath, 32,xdim0,xdim1,xdim2,xdim3,xdim4);
          else {
