...
//
__constant__ int dims_opensbliblock00Kernel031 [5][1];
static int dims_opensbliblock00Kernel031_h [5][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel031_gpu(ACC<double> &D00_B0,
  ACC<double> &D01_B0,
  ACC<double> &D10_B0,
  ACC<double> &D11_B0,
  ACC<double> &detJ_B0)
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    opensbliblock00Kernel031_gpu(argp0, argp1, argp2, argp3,
                   argp4);
  }
...
void ops_par_loop_opensbliblock00Kernel031_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel031_h[0][0] || xdim1 != dims_opensbliblock00Kernel031_h[1][0] || xdim2 != dims_opensbliblock00Kernel031_h[2][0] || xdim3 != dims_opensbliblock00Kernel031_h[3][0] || xdim4 != dims_opensbliblock00Kernel031_h[4][0]) {
