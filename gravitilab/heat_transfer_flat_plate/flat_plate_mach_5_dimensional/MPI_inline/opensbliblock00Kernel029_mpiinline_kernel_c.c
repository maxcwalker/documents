...
void opensbliblock00Kernel029_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      const ptr_double x0_B0 = { x0_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel029*1, xdim0_opensbliblock00Kernel029};
      const ptr_double x1_B0 = { x1_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel029*1, xdim1_opensbliblock00Kernel029};
      ptr_double D00_B0 = { D00_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel029*1, xdim2_opensbliblock00Kernel029};
      ptr_double D01_B0 = { D01_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel029*1, xdim3_opensbliblock00Kernel029};
      ptr_double D10_B0 = { D10_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel029*1, xdim4_opensbliblock00Kernel029};
      ptr_double D11_B0 = { D11_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel029*1, xdim5_opensbliblock00Kernel029};
      ptr_double detJ_B0 = { detJ_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel029*1, xdim6_opensbliblock00Kernel029};
      ptr_double wk0_B0 = { wk0_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel029*1, xdim7_opensbliblock00Kernel029};
      ptr_double wk1_B0 = { wk1_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel029*1, xdim8_opensbliblock00Kernel029};
      ptr_double wk2_B0 = { wk2_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel029*1, xdim9_opensbliblock00Kernel029};
      ptr_double wk3_B0 = { wk3_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel029*1, xdim10_opensbliblock00Kernel029};
...
: ((idx[1] == -1
      + block0np1) ? (
   -4*OPS_ACC(x0_B0, 0,-1) + 3*OPS_ACC(x0_B0, 0,-2) - (4.0/3.0)*OPS_ACC(x0_B0, 0,-3) + ((1.0/4.0))*OPS_ACC(x0_B0, 0,-4) +
      ((25.0/12.0))*OPS_ACC(x0_B0, 0,0)
)
: ((idx[1] == -2 + block0np1) ? (
   ((1.0/2.0))*OPS_ACC(x0_B0, 0,-2) - (3.0/2.0)*OPS_ACC(x0_B0, 0,-1) -
      (1.0/12.0)*OPS_ACC(x0_B0, 0,-3) + ((1.0/4.0))*OPS_ACC(x0_B0, 0,1) + ((5.0/6.0))*OPS_ACC(x0_B0, 0,0)
)
: (
   -(2.0/3.0)*OPS_ACC(x0_B0, 0,-1) -
      (1.0/12.0)*OPS_ACC(x0_B0, 0,2) + ((1.0/12.0))*OPS_ACC(x0_B0, 0,-2) + ((2.0/3.0))*OPS_ACC(x0_B0, 0,1)
)))));
...
: ((idx[1] == -1
      + block0np1) ? (
   -4*OPS_ACC(x1_B0, 0,-1) + 3*OPS_ACC(x1_B0, 0,-2) - (4.0/3.0)*OPS_ACC(x1_B0, 0,-3) + ((1.0/4.0))*OPS_ACC(x1_B0, 0,-4) +
      ((25.0/12.0))*OPS_ACC(x1_B0, 0,0)
)
: ((idx[1] == -2 + block0np1) ? (
   ((1.0/2.0))*OPS_ACC(x1_B0, 0,-2) - (3.0/2.0)*OPS_ACC(x1_B0, 0,-1) -
      (1.0/12.0)*OPS_ACC(x1_B0, 0,-3) + ((1.0/4.0))*OPS_ACC(x1_B0, 0,1) + ((5.0/6.0))*OPS_ACC(x1_B0, 0,0)
)
: (
   -(2.0/3.0)*OPS_ACC(x1_B0, 0,-1) -
      (1.0/12.0)*OPS_ACC(x1_B0, 0,2) + ((1.0/12.0))*OPS_ACC(x1_B0, 0,-2) + ((2.0/3.0))*OPS_ACC(x1_B0, 0,1)
)))));
