...
void opensbliblock00Kernel003_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      const ptr_double theta_B0 = { theta_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel003*1, xdim0_opensbliblock00Kernel003};
      ...
      const ptr_double p_B0 = { p_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel003*1, xdim3_opensbliblock00Kernel003};
      const ptr_double rhou1_B0 = { rhou1_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel003*1, xdim4_opensbliblock00Kernel003};
      const ptr_double a_B0 = { a_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel003*1, xdim5_opensbliblock00Kernel003};
      const ptr_double rhou0_B0 = { rhou0_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel003*1, xdim6_opensbliblock00Kernel003};
   ...
   CS_15 = AVG_0_0_LEV_10*OPS_ACC(rho_B0, 3,0) + AVG_0_0_LEV_12*OPS_ACC(rhou1_B0, 3,0);
    ...
    max_lambda_0_00 = fmax(fabs(OPS_ACC(u0_B0, 2,0)), fmax(fabs(OPS_ACC(u0_B0, 0,0)),
      fmax(fabs(OPS_ACC(u0_B0, -2,0)), fmax(fabs(OPS_ACC(u0_B0, -1,0)), fmax(fabs(OPS_ACC(u0_B0, 3,0)),
      fabs(OPS_ACC(u0_B0, 1,0)))))));

   max_lambda_0_11 = max_lambda_0_00;

    max_lambda_0_22 = fmax(fabs(OPS_ACC(a_B0, 2,0) + OPS_ACC(u0_B0, 2,0)), fmax(fabs(OPS_ACC(a_B0, -2,0) +
      OPS_ACC(u0_B0, -2,0)), fmax(fabs(OPS_ACC(a_B0, 1,0) + OPS_ACC(u0_B0, 1,0)), fmax(fabs(OPS_ACC(a_B0, -1,0) +
      OPS_ACC(u0_B0, -1,0)), fmax(fabs(OPS_ACC(a_B0, 0,0) + OPS_ACC(u0_B0, 0,0)), fabs(OPS_ACC(a_B0, 3,0) +
      OPS_ACC(u0_B0, 3,0)))))));

    max_lambda_0_33 = fmax(fabs(OPS_ACC(a_B0, -2,0) - OPS_ACC(u0_B0, -2,0)), fmax(fabs(OPS_ACC(a_B0, 2,0) -
      OPS_ACC(u0_B0, 2,0)), fmax(fabs(OPS_ACC(a_B0, 3,0) - OPS_ACC(u0_B0, 3,0)), fmax(fabs(OPS_ACC(a_B0, 1,0) -
      OPS_ACC(u0_B0, 1,0)), fmax(fabs(OPS_ACC(a_B0, -1,0) - OPS_ACC(u0_B0, -1,0)), fabs(OPS_ACC(a_B0, 0,0) -
      OPS_ACC(u0_B0, 0,0)))))));
