...
void opensbliblock00Kernel004_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      const ptr_double theta_B0 = { theta_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel004*1, xdim0_opensbliblock00Kernel004};
      const ptr_double rhoE_B0 = { rhoE_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel004*1, xdim1_opensbliblock00Kernel004};
      const ptr_double rho_B0 = { rho_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel004*1, xdim2_opensbliblock00Kernel004};
      const ptr_double p_B0 = { p_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel004*1, xdim3_opensbliblock00Kernel004};
      const ptr_double rhou1_B0 = { rhou1_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel004*1, xdim4_opensbliblock00Kernel004};
      const ptr_double a_B0 = { a_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel004*1, xdim5_opensbliblock00Kernel004};
      const ptr_double rhou0_B0 = { rhou0_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel004*1, xdim6_opensbliblock00Kernel004};
      ...
      ptr_double wk4_B0 = { wk4_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel004*1, xdim11_opensbliblock00Kernel004};
