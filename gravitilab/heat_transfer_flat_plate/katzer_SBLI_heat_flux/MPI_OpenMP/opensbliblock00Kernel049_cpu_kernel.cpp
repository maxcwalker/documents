...
void ops_par_loop_opensbliblock00Kernel049_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      ACC<double> tempRK_rhou0_B0(xdim4_opensbliblock00Kernel049, tempRK_rhou0_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel049*1);
      ACC<double> tempRK_rhoE_B0(xdim5_opensbliblock00Kernel049, tempRK_rhoE_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel049*1);
      ACC<double> rhoE_B0(xdim6_opensbliblock00Kernel049, rhoE_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel049*1);
      ACC<double> rho_B0(xdim7_opensbliblock00Kernel049, rho_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel049*1);
      ACC<double> tempRK_rhou1_B0(xdim8_opensbliblock00Kernel049, tempRK_rhou1_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel049*1);
      ACC<double> rhou1_B0(xdim9_opensbliblock00Kernel049, rhou1_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel049*1);
      ACC<double> tempRK_rho_B0(xdim10_opensbliblock00Kernel049, tempRK_rho_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel049*1);
