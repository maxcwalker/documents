...
void ops_par_loop_opensbliblock00Kernel003_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      const ACC<double> theta_B0(xdim0_opensbliblock00Kernel003, theta_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel003*1);
      ...
      const ACC<double> p_B0(xdim3_opensbliblock00Kernel003, p_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel003*1);
      const ACC<double> rhou1_B0(xdim4_opensbliblock00Kernel003, rhou1_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel003*1);
      const ACC<double> a_B0(xdim5_opensbliblock00Kernel003, a_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel003*1);
      const ACC<double> rhou0_B0(xdim6_opensbliblock00Kernel003, rhou0_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel003*1);
   ...
   CS_15 = AVG_0_0_LEV_10*rho_B0(3,0) + AVG_0_0_LEV_12*rhou1_B0(3,0);
    ...
    max_lambda_0_00 = fmax(fabs(u0_B0(2,0)), fmax(fabs(u0_B0(0,0)),
      fmax(fabs(u0_B0(-2,0)), fmax(fabs(u0_B0(-1,0)), fmax(fabs(u0_B0(3,0)),
      fabs(u0_B0(1,0)))))));

   max_lambda_0_11 = max_lambda_0_00;

    max_lambda_0_22 = fmax(fabs(a_B0(2,0) + u0_B0(2,0)), fmax(fabs(a_B0(-2,0) +
      u0_B0(-2,0)), fmax(fabs(a_B0(1,0) + u0_B0(1,0)), fmax(fabs(a_B0(-1,0) +
      u0_B0(-1,0)), fmax(fabs(a_B0(0,0) + u0_B0(0,0)), fabs(a_B0(3,0) +
      u0_B0(3,0)))))));

    max_lambda_0_33 = fmax(fabs(a_B0(-2,0) - u0_B0(-2,0)), fmax(fabs(a_B0(2,0) -
      u0_B0(2,0)), fmax(fabs(a_B0(3,0) - u0_B0(3,0)), fmax(fabs(a_B0(1,0) -
      u0_B0(1,0)), fmax(fabs(a_B0(-1,0) - u0_B0(-1,0)), fabs(a_B0(0,0) -
      u0_B0(0,0)))))));
